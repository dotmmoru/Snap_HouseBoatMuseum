 ...
 * // Instead, you should modify the "HouseBoatMuseum API" script and access the functions through the imported class wrapper.
 */
...
class ApiModule extends RemoteApiService {
    /**
     * Performs event_triggered API call.
     *
     ...
     * });
     */
    event_triggered(request) {
        return this.performApiRequest("event_triggered", request);
    }
}
