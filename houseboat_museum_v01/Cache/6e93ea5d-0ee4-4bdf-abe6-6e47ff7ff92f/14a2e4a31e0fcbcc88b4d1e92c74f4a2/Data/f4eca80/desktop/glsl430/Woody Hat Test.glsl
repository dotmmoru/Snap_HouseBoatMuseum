...
{
l9_4=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#endif
float l9_6=l9_5.y*rough;
vec3 l9_7;
#if (!sc_ProjectiveShadowsCaster)
{
l9_7=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_4.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_7=vec3(0.0);
...
#endif
float l9_8=clamp(l9_3.w,0.0,1.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_7)>=(-0.050000001))
{
uvec3 l9_9=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_9.x,l9_9.y,l9_9.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_10=abs(l9_7);
vec3 l9_11=l9_7/vec3(dot(l9_10,vec3(1.0)));
float l9_12=clamp(-l9_11.z,0.0,1.0);
float l9_13=l9_11.x;
float l9_14;
if (l9_13>=0.0)
{
...
uvec2 l9_18=uvec2(packHalf2x16(vec2(l9_15,0.0)),packHalf2x16(vec2(l9_16+l9_17,0.0)));
normal_and_more=uvec4(l9_18.x,l9_18.y,normal_and_more.z,normal_and_more.w);
...
{
l9_19=uint(clamp(l9_6,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_19|uint((receiverId%32)<<int(10u));
}
else
{
...
#if (baseTexLayout==2)
{
l9_12=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_12=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec4 l9_13=baseColor*l9_12;
vec4 l9_14;
#if (normalTexLayout==2)
{
l9_14=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_14=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#if (materialParamsTexLayout==2)
{
l9_15=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_15=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_16=mat3(l9_3,l9_1,l9_2)*((l9_14.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_16=vec3(0.0);
...
#endif
float l9_17=clamp(l9_13.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_18=max(l9_13.xyz,vec3(0.0));
vec4 l9_19;
#if (sc_ProjectiveShadowsCaster)
{
l9_19=vec4(l9_18,l9_17);
}
#else
{
l9_19=ngsCalculateLighting(l9_18,l9_17,l9_16,l9_4,l9_5,Port_Emissive_N006,clamp(l9_15.x*metal,0.0,1.0),clamp(l9_15.y*rough,0.0,1.0),clamp(vec3(l9_15.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_20=max(l9_19,vec4(0.0));
if (isProxyMode)
{
vec4 l9_21;
#if (sc_ProxyAlphaOne)
...
{
float l9_42=l9_20.w;
l9_41=vec4(mix(vec3(1.0),l9_20.xyz,vec3(l9_42)),l9_42);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_20.xyz*l9_45,l9_45);
}
#else
{
l9_43=l9_20;
