...
vec4 l9_18=sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_15,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2);
...
gParticle.Size=0.0+(((DecodeFloat16(vec2(l9_16.xy),true)-0.0)*(100.0-0.0))/(0.99998999-0.0));
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_16.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_17.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_17.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_18.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Mass=0.0+(((DecodeFloat16(vec2(l9_18.zw),true)-0.0)*(100.0-0.0))/(0.99998999-0.0));
gParticle.Color.x=0.0+(((DecodeFloat8(l9_19.x,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.y=0.0+(((DecodeFloat8(l9_19.y,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.z=0.0+(((DecodeFloat8(l9_19.z,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.w=0.0+(((DecodeFloat8(l9_19.w,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
vec4 l9_20=normalize(gParticle.Quaternion.yzwx);
float l9_21=l9_20.x;
float l9_22=l9_21*l9_21;
float l9_23=l9_20.y;
float l9_24=l9_23*l9_23;
float l9_25=l9_20.z;
float l9_26=l9_25*l9_25;
float l9_27=l9_21*l9_25;
float l9_28=l9_21*l9_23;
float l9_29=l9_23*l9_25;
float l9_30=l9_20.w;
float l9_31=l9_30*l9_21;
float l9_32=l9_30*l9_23;
float l9_33=l9_30*l9_25;
gParticle.Matrix=mat3(vec3(1.0-(2.0*(l9_24+l9_26)),2.0*(l9_28+l9_33),2.0*(l9_27-l9_32)),vec3(2.0*(l9_28-l9_33),1.0-(2.0*(l9_22+l9_26)),2.0*(l9_29+l9_31)),vec3(2.0*(l9_27+l9_32),2.0*(l9_29-l9_31),1.0-(2.0*(l9_22+l9_24))));
...
#if (sc_CanUseTextureLod)
{
l9_0=texture3DLod(texsmp,uv,level_);
}
#else
{
l9_0=vec4(0.0);
...
vec4 l9_70=vec4(l9_17,l9_18,l9_19,l9_20);
vec4 l9_71;
if (dot(((l9_67+l9_68)+l9_69)+l9_70,vec4(0.23454))==0.34231836)
{
l9_71=l9_67+vec4(1e-06);
}
else
{
l9_71=l9_67;
