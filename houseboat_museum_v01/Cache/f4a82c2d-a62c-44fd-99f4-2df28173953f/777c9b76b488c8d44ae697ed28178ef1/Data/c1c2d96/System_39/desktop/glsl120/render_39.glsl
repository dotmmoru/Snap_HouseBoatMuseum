...
gParticle.Life=0.0+(((DecodeFloat32(sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2),true)-0.0)*(3.0-0.0))/(0.99998999-0.0));
gParticle.Age=0.0+(((DecodeFloat32(sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3),true)-0.0)*(3.0-0.0))/(0.99998999-0.0));
vec2 l9_17=l9_11+vec2(0.0009765625,0.0);
vec4 l9_18=sc_SampleTextureLevel(renderTarget0Dims.xy,renderTarget0Layout,renderTarget0GetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_renderTarget0)!=0),renderTarget0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget0,SC_SOFTWARE_WRAP_MODE_V_renderTarget0),(int(SC_USE_UV_MIN_MAX_renderTarget0)!=0),renderTarget0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget0)!=0),renderTarget0BorderColor,0.0,renderTarget0);
...
vec4 l9_20=sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2);
vec4 l9_21=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3);
...
vec2 l9_7=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_8=sc_ScreenCoordsGlobalToView(l9_7);
int l9_9=int(Interp_Particle_Index);
float l9_10=(float(((l9_9*((l9_9*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10)*l9_6;
float l9_11=l9_5-l9_10;
vec2 l9_12=(l9_8+Port_Input1_N050)+(varPackedTex.xy*vec2(Port_Input1_N176));
float l9_13=l9_12.x;
float l9_14=l9_12.y;
float l9_15=(l9_13*l9_13)+(l9_14*l9_14);
float l9_16;
if (l9_15<=0.0)
{
l9_16=0.0;
...
float l9_17=l9_16+((l9_11-0.0)*Port_Multiplier_N098);
int l9_18;
...
#endif
vec4 l9_19=sc_SampleTextureBiasOrLevel(Tweak_N52Dims.xy,Tweak_N52Layout,l9_18,vec2((((atan(l9_14,l9_13)-Port_RangeMinA_N097)/(Port_RangeMaxA_N097-Port_RangeMinA_N097))*(Port_RangeMaxB_N097-Port_RangeMinB_N097))+Port_RangeMinB_N097,l9_17*Port_Input1_N101),(int(SC_USE_UV_TRANSFORM_Tweak_N52)!=0),Tweak_N52Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N52,SC_SOFTWARE_WRAP_MODE_V_Tweak_N52),(int(SC_USE_UV_MIN_MAX_Tweak_N52)!=0),Tweak_N52UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N52)!=0),Tweak_N52BorderColor,0.0,Tweak_N52);
float l9_20=(((clamp(Interp_Particle_Age/Interp_Particle_Life,0.0,1.0)-Port_RangeMinA_N185)/(Port_RangeMaxA_N185-Port_RangeMinA_N185))*(Port_RangeMaxB_N185-Port_RangeMinB_N185))+Port_RangeMinB_N185;
float l9_21;
if (Port_RangeMaxB_N185>Port_RangeMinB_N185)
{
l9_21=clamp(l9_20,Port_RangeMinB_N185,Port_RangeMaxB_N185);
}
else
{
l9_21=clamp(l9_20,Port_RangeMaxB_N185,Port_RangeMinB_N185);
}
...
#endif
vec4 l9_24=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_23,varPackedTex.xy+((l9_19*vec4(Port_Input1_N173))*l9_22).xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_25=Interp_Particle_Color*l9_24;
float l9_26=l9_25.x;
float l9_27=l9_25.w;
float l9_28=(((Interp_Particle_Position.z-Port_RangeMinA_N044)/(Port_RangeMaxA_N044-Port_RangeMinA_N044))*(Port_RangeMaxB_N044-Port_RangeMinB_N044))+Port_RangeMinB_N044;
float l9_29;
if (Port_RangeMaxB_N044>Port_RangeMinB_N044)
{
l9_29=clamp(l9_28,Port_RangeMinB_N044,Port_RangeMaxB_N044);
}
else
{
l9_29=clamp(l9_28,Port_RangeMaxB_N044,Port_RangeMinB_N044);
}
float l9_30=(((abs(length(Interp_Particle_Velocity))-Port_RangeMinA_N189)/(Port_RangeMaxA_N189-Port_RangeMinA_N189))*(Port_RangeMaxB_N189-Port_RangeMinB_N189))+Port_RangeMinB_N189;
float l9_31;
if (Port_RangeMaxB_N189>Port_RangeMinB_N189)
{
l9_31=clamp(l9_30,Port_RangeMinB_N189,Port_RangeMaxB_N189);
}
else
{
l9_31=clamp(l9_30,Port_RangeMaxB_N189,Port_RangeMinB_N189);
}
vec4 l9_32=vec4(l9_26,l9_29,l9_31,l9_27);
if (l9_26<float(l9_27<Port_Input1_N150))
{
discard;
}
vec4 l9_33;
...
{
l9_36=clamp(dot(l9_32.xyz,vec3(l9_27)),0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_38=(1.0-dot(l9_32.xyz,vec3(0.33333001)))*l9_27;
}
#else
{
float l9_39;
...
{
l9_39=(1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0))*l9_27;
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_41;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_42=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*l9_27;
}
#else
{
float l9_43;
...
{
l9_43=dot(l9_32.xyz,vec3(0.33333001))*l9_27;
}
#else
{
float l9_44;
...
#else
{
vec2 l9_52=sc_ScreenCoordsGlobalToView(l9_7);
int l9_53;
...
#endif
vec3 l9_56=mix(l9_54.xyz,definedBlend(l9_54.xyz,l9_32.xyz).xyz,vec3(l9_27));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_58=vec4(mix(vec3(1.0),l9_32.xyz,vec3(l9_27)),l9_27);
}
#else
{
vec4 l9_59;
...
#endif
l9_59=vec4(l9_32.xyz*l9_60,l9_60);
}
#else
{
l9_59=l9_32;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_65=sc_ScreenCoordsGlobalToView(l9_7);
...
#if (sc_OITCompositingPass)
{
vec2 l9_78=sc_ScreenCoordsGlobalToView(l9_7);
#if (sc_OITMaxLayers4Plus1)
{
...
#if (sc_OITFrontLayerPass)
{
if (abs(gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,sc_ScreenCoordsGlobalToView(l9_7)).x)>getFrontLayerZTestEpsilon())
{
discard;
}
