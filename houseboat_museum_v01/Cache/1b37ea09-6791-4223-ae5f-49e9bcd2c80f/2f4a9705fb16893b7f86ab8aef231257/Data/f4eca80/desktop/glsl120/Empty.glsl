...
#endif
float l9_0=((((sc_ModelMatrixInverse*vec4(varPos,1.0)).y-Port_RangeMinA_N002)/(Port_RangeMaxA_N002-Port_RangeMinA_N002))*(Port_RangeMaxB_N002-Port_RangeMinB_N002))+Port_RangeMinB_N002;
float l9_1;
if (Port_RangeMaxB_N002>Port_RangeMinB_N002)
{
l9_1=clamp(l9_0,Port_RangeMinB_N002,Port_RangeMaxB_N002);
}
else
{
l9_1=clamp(l9_0,Port_RangeMaxB_N002,Port_RangeMinB_N002);
}
float l9_2=smoothstep(Port_Input0_N009,Port_Input1_N009,l9_1);
vec4 l9_3=vec4(l9_2,l9_2,l9_2,1.0);
...
{
l9_7=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_3.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_15;
...
#endif
vec3 l9_27=definedBlend(l9_25.xyz,l9_3.xyz);
