...
float l9_2=(((l9_0.y-Port_RangeMinA_N002)/(Port_RangeMaxA_N002-Port_RangeMinA_N002))*(Port_RangeMaxB_N002-Port_RangeMinB_N002))+Port_RangeMinB_N002;
float l9_3;
if (Port_RangeMaxB_N002>Port_RangeMinB_N002)
{
l9_3=clamp(l9_2,Port_RangeMinB_N002,Port_RangeMaxB_N002);
}
else
{
l9_3=clamp(l9_2,Port_RangeMaxB_N002,Port_RangeMinB_N002);
}
float l9_4=smoothstep(Port_Input0_N009,Port_Input1_N009,l9_3);
vec4 l9_5=vec4(l9_4,l9_4,l9_4,1.0);
...
{
l9_11=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_16;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_5.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_19;
...
#endif
vec3 l9_32=definedBlend(l9_30.xyz,l9_5.xyz);
