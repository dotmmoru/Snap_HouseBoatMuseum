...
float l9_1=abs(l9_0.x)*Port_Input1_N010;
float l9_2;
if (l9_1<=0.0)
{
l9_2=0.0;
...
{
l9_2=pow(l9_1,Port_Input1_N008);
}
float l9_3=l9_2-Port_RangeMinA_N006;
float l9_4=((l9_3/(Port_RangeMaxA_N006-Port_RangeMinA_N006))*(Port_RangeMaxB_N006-Port_RangeMinB_N006))+Port_RangeMinB_N006;
float l9_5;
if (Port_RangeMaxB_N006>Port_RangeMinB_N006)
{
l9_5=clamp(l9_4,Port_RangeMinB_N006,Port_RangeMaxB_N006);
}
else
{
l9_5=clamp(l9_4,Port_RangeMaxB_N006,Port_RangeMinB_N006);
}
float l9_6=l9_5+Port_Input1_N005;
float l9_7=l9_0.y-l9_5;
float l9_8=l9_6-l9_5;
float l9_9=((l9_7/l9_8)*(Port_RangeMaxB_N002-Port_RangeMinB_N002))+Port_RangeMinB_N002;
float l9_10;
if (Port_RangeMaxB_N002>Port_RangeMinB_N002)
{
l9_10=clamp(l9_9,Port_RangeMinB_N002,Port_RangeMaxB_N002);
}
else
{
l9_10=clamp(l9_9,Port_RangeMaxB_N002,Port_RangeMinB_N002);
}
float l9_11=smoothstep(Port_Input0_N009,Port_Input1_N009,l9_10);
vec4 l9_12=vec4(l9_11,l9_11,l9_11,1.0);
