...
uniform float Port_RangeMinA_N006;
uniform float Port_RangeMaxA_N006;
uniform float Port_RangeMinB_N006;
uniform float Port_RangeMaxB_N006;
...
l9_0=(sc_ModelMatrixInverse*vec4(l9_1.positionWS,1.0)).xyz;
}
else
{
l9_0=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
}
float l9_2=abs(l9_0.x)*Port_Input1_N010;
float l9_3;
if (l9_2<=0.0)
{
l9_3=0.0;
...
{
l9_3=pow(l9_2,Port_Input1_N008);
}
float l9_4=l9_3-Port_RangeMinA_N006;
float l9_5=((l9_4/(Port_RangeMaxA_N006-Port_RangeMinA_N006))*(Port_RangeMaxB_N006-Port_RangeMinB_N006))+Port_RangeMinB_N006;
float l9_6;
if (Port_RangeMaxB_N006>Port_RangeMinB_N006)
{
l9_6=clamp(l9_5,Port_RangeMinB_N006,Port_RangeMaxB_N006);
}
else
{
l9_6=clamp(l9_5,Port_RangeMaxB_N006,Port_RangeMinB_N006);
}
float l9_7=l9_6+Port_Input1_N005;
float l9_8=l9_0.y-l9_6;
float l9_9=l9_7-l9_6;
float l9_10=((l9_8/l9_9)*(Port_RangeMaxB_N002-Port_RangeMinB_N002))+Port_RangeMinB_N002;
float l9_11;
if (Port_RangeMaxB_N002>Port_RangeMinB_N002)
{
l9_11=clamp(l9_10,Port_RangeMinB_N002,Port_RangeMaxB_N002);
}
else
{
l9_11=clamp(l9_10,Port_RangeMaxB_N002,Port_RangeMinB_N002);
}
float l9_12=smoothstep(Port_Input0_N009,Port_Input1_N009,l9_11);
vec4 l9_13=vec4(l9_12,l9_12,l9_12,1.0);
