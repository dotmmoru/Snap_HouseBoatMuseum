...
//sampler sampler Tweak_N3SmpSC 2:18
...
//texture texture2D Tweak_N3 2:1:2:18
...
Output+=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),Globals.gScreenCoord+((Tweak_N3Size.zw*vec2(exp2(Port_Import_N044)))*param_1),(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,Port_Import_N044+Port_Input1_N045,Tweak_N3);
}
...
#endif
vec4 l9_6=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,l9_5,l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0);
float l9_7=l9_6.x;
vec4 l9_8=baseColor*vec4(1.0,1.0,1.0,l9_7);
vec4 l9_9=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,Port_Import_N044+Port_Input1_N045,Tweak_N3);
vec4 l9_10=vec4(0.0);
ssGlobals l9_11=ssGlobals(l9_1,l9_2,0.0,l9_4,0.0,0.0,8.0);
...
vec4 l9_18=l9_10;
bool l9_19=(float(l9_7>=Port_Input1_N016)*1.0)!=0.0;
bool l9_20;
if (!l9_19)
{
l9_20=(float(mix(l9_9,l9_18/vec4(8.0),vec4(Port_Input2_N023)).x<Port_Input1_N008)*1.0)!=0.0;
}
else
{
l9_20=l9_19;
...
{
l9_25=clamp(dot(l9_8.xyz,vec3(l9_21)),0.0,1.0);
}
#else
{
float l9_26;
...
{
l9_27=(1.0-dot(l9_8.xyz,vec3(0.33333001)))*l9_21;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0))*l9_21;
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_30;
#if (sc_BlendMode_Add)
{
l9_30=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_8.xyz,vec3(0.33333001))*l9_21;
}
#else
{
float l9_33;
#if (sc_BlendMode_Min)
{
l9_33=1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_Max)
{
l9_34=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_34=1.0;
...
#endif
l9_22=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_8.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_23);
}
#else
{
vec4 l9_35;
...
#endif
vec3 l9_45=mix(l9_43.xyz,definedBlend(l9_43.xyz,l9_8.xyz).xyz,vec3(l9_21));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_47=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_21)),l9_21);
}
#else
{
vec4 l9_48;
...
#endif
l9_48=vec4(l9_8.xyz*l9_49,l9_49);
}
#else
{
l9_48=l9_8;
