...
//sampler sampler Tweak_N0SmpSC 2:22
//sampler sampler Tweak_N3SmpSC 2:23
...
//texture texture2D Tweak_N0 2:3:2:22
//texture texture2D Tweak_N3 2:4:2:23
...
//texture texture2DArray Tweak_N0ArrSC 2:34:2:22
//texture texture2DArray Tweak_N3ArrSC 2:35:2:23
...
uniform vec2 Port_Item0_N018;
uniform vec2 Port_Item1_N018;
uniform vec2 Port_Item2_N018;
uniform vec2 Port_Item3_N018;
uniform vec2 Port_Item4_N018;
uniform vec2 Port_Item5_N018;
uniform vec2 Port_Item6_N018;
uniform vec2 Port_Item7_N018;
...
void Node18_Float_Array_Value(float Index,out vec2 Value,out float SizeOut,vec2 Item0,vec2 Item1,vec2 Item2,vec2 Item3,vec2 Item4,vec2 Item5,vec2 Item6,vec2 Item7,ssGlobals Globals)
{
vec2 Array[8];
Array[0]=Item0;
Array[1]=Item1;
...
void LoopFunction_N22(float Index,float Ratio,inout vec4 Output,ssGlobals Globals)
{
...
vec2 param_1;
float param_2;
Node18_Float_Array_Value(Globals.Loop_Index_ID0,param_1,param_2,Port_Item0_N018,Port_Item1_N018,Port_Item2_N018,Port_Item3_N018,Port_Item4_N018,Port_Item5_N018,Port_Item6_N018,Port_Item7_N018,Globals);
vec2 l9_1=param_1;
vec2 l9_2=l9_0+((Tweak_N3Size.zw*vec2(exp2(Port_Import_N044)))*l9_1);
float l9_3=Port_Import_N044+Port_Input1_N045;
vec4 l9_4;
#if (Tweak_N3Layout==2)
{
l9_4=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,l9_3,Tweak_N3ArrSC);
}
#else
{
l9_4=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,l9_3,Tweak_N3);
}
#endif
Output+=l9_4;
}
...
l9_3=((l9_5.xy/vec2(l9_5.w))*0.5)+vec2(0.5);
}
else
{
...
#if (Tweak_N0Layout==2)
{
l9_6=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0ArrSC);
}
#else
{
...
#endif
vec4 l9_7=baseColor*vec4(1.0,1.0,1.0,l9_6.x);
float l9_8=Port_Import_N044+Port_Input1_N045;
vec4 l9_9;
#if (Tweak_N3Layout==2)
{
l9_9=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,l9_8,Tweak_N3ArrSC);
}
#else
{
l9_9=sc_SampleTextureLevel(Tweak_N3Dims.xy,Tweak_N3Layout,Tweak_N3GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,l9_8,Tweak_N3);
}
#endif
vec4 l9_10=vec4(0.0);
ssGlobals l9_11=ssGlobals(l9_1,l9_2,0.0,l9_3,0.0,0.0,8.0);
LoopFunction_N22(0.0,0.0,l9_10,l9_11);
LoopFunction_N22(1.0,0.142857,l9_10,l9_11);
LoopFunction_N22(2.0,0.285714,l9_10,l9_11);
LoopFunction_N22(3.0,0.42857099,l9_10,l9_11);
LoopFunction_N22(4.0,0.57142901,l9_10,l9_11);
LoopFunction_N22(5.0,0.71428603,l9_10,l9_11);
LoopFunction_N22(6.0,0.85714298,l9_10,l9_11);
LoopFunction_N22(7.0,1.0,l9_10,l9_11);
vec4 l9_18=l9_10;
vec4 l9_19=mix(l9_9,l9_18/vec4(8.0),vec4(Port_Input2_N023));
bool l9_20=(float(l9_6.x>=Port_Input1_N016)*1.0)!=0.0;
bool l9_21;
if (!l9_20)
{
l9_21=(float(l9_19.x<Port_Input1_N008)*1.0)!=0.0;
}
else
{
l9_21=l9_20;
}
if ((float(l9_21)*1.0)!=0.0)
{
discard;
}
float l9_22=l9_7.w;
...
{
l9_28=clamp(dot(l9_7.xyz,vec3(l9_22)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_22;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_22;
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_22;
}
#else
{
float l9_33;
#if (sc_BlendMode_Add)
{
l9_33=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_22;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_7.xyz,vec3(0.33333001))*l9_22;
}
#else
{
float l9_36;
#if (sc_BlendMode_Min)
{
l9_36=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_37;
#if (sc_BlendMode_Max)
{
l9_37=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_37=1.0;
...
#endif
l9_25=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_26);
}
#else
{
vec4 l9_38;
...
{
l9_46=sc_SampleView(sc_ScreenTextureDims.xy,l9_44,sc_ScreenTextureLayout,l9_45,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_46=sc_SampleView(sc_ScreenTextureDims.xy,l9_44,sc_ScreenTextureLayout,l9_45,0.0,sc_ScreenTexture);
}
#endif
l9_40=l9_46;
}
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_7.xyz).xyz,vec3(l9_22));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_22)),l9_22);
}
#else
{
vec4 l9_52;
...
#endif
l9_52=vec4(l9_7.xyz*l9_53,l9_53);
}
#else
{
l9_52=l9_7;
