...
//sampler sampler Tweak_N13SmpSC 2:23
...
//texture texture2D Tweak_N13 2:4:2:23
...
//texture texture2DArray Tweak_N13ArrSC 2:35:2:23
...
uniform vec4 Tweak_N13Size;
uniform vec4 Tweak_N13View;
...
l9_1=l9_2.uv0;
l9_0=((l9_3.xy/vec2(l9_3.w))*0.5)+vec2(0.5);
}
else
{
...
#if (Tweak_N0Layout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0ArrSC);
}
#else
{
...
#endif
vec4 l9_5=baseColor*vec4(1.0,1.0,1.0,l9_4.x);
vec4 l9_6;
#if (Tweak_N13Layout==2)
{
l9_6=sc_SampleTextureBiasOrLevel(Tweak_N13Dims.xy,Tweak_N13Layout,Tweak_N13GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N13)!=0),Tweak_N13Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N13,SC_SOFTWARE_WRAP_MODE_V_Tweak_N13),(int(SC_USE_UV_MIN_MAX_Tweak_N13)!=0),Tweak_N13UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N13)!=0),Tweak_N13BorderColor,0.0,Tweak_N13ArrSC);
}
#else
{
l9_6=sc_SampleTextureBiasOrLevel(Tweak_N13Dims.xy,Tweak_N13Layout,Tweak_N13GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N13)!=0),Tweak_N13Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N13,SC_SOFTWARE_WRAP_MODE_V_Tweak_N13),(int(SC_USE_UV_MIN_MAX_Tweak_N13)!=0),Tweak_N13UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N13)!=0),Tweak_N13BorderColor,0.0,Tweak_N13);
}
#endif
bool l9_7=(float(l9_4.x>=Port_Input1_N016)*1.0)!=0.0;
bool l9_8;
if (!l9_7)
{
l9_8=(float(l9_6.x<=Port_Input1_N029)*1.0)!=0.0;
}
else
{
l9_8=l9_7;
...
{
l9_15=clamp(dot(l9_5.xyz,vec3(l9_9)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_9;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_9;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_9;
}
#else
{
float l9_20;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_9;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_5.xyz,vec3(0.33333001))*l9_9;
}
#else
{
float l9_23;
#if (sc_BlendMode_Min)
{
l9_23=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
#endif
vec3 l9_36=mix(l9_34.xyz,definedBlend(l9_34.xyz,l9_5.xyz).xyz,vec3(l9_9));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_38=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_9)),l9_9);
}
#else
{
vec4 l9_39;
...
#endif
l9_39=vec4(l9_5.xyz*l9_40,l9_40);
}
#else
{
l9_39=l9_5;
