...
//sampler sampler Tweak_N13SmpSC 2:18
...
//texture texture2D Tweak_N13 2:1:2:18
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,l9_2,l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0);
float l9_4=l9_3.x;
vec4 l9_5=baseColor*vec4(1.0,1.0,1.0,l9_4);
int l9_6;
...
{
l9_14=clamp(dot(l9_5.xyz,vec3(l9_10)),0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_16=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_10;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_10;
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_10;
}
#else
{
float l9_19;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_10;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_5.xyz,vec3(0.33333001))*l9_10;
}
#else
{
float l9_22;
#if (sc_BlendMode_Min)
{
l9_22=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_23;
#if (sc_BlendMode_Max)
{
l9_23=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_23=1.0;
...
#endif
l9_11=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_12);
}
#else
{
vec4 l9_24;
...
#else
{
vec2 l9_30=sc_ScreenCoordsGlobalToView(l9_0);
int l9_31;
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_5.xyz).xyz,vec3(l9_10));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_10)),l9_10);
}
#else
{
vec4 l9_37;
...
#endif
l9_37=vec4(l9_5.xyz*l9_38,l9_38);
}
#else
{
l9_37=l9_5;
