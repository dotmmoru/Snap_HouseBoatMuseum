...
#endif
vec4 l9_8=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,l9_7,l9_3,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
int l9_9;
...
#endif
vec4 l9_10=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,l9_9,l9_3,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
vec3 l9_11;
#if (!sc_ProjectiveShadowsCaster)
{
l9_11=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_8.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_11=vec3(0.0);
...
#endif
float l9_12=clamp(l9_6.w,0.0,1.0);
...
#endif
vec3 l9_13=max(l9_6.xyz,vec3(0.0));
vec4 l9_14;
#if (sc_ProjectiveShadowsCaster)
{
l9_14=vec4(l9_13,l9_12);
}
#else
{
float l9_15=clamp(l9_10.x,0.0,1.0);
float l9_16=clamp(l9_10.y,0.0,1.0);
vec3 l9_17=ssSRGB_to_Linear(l9_13);
vec3 l9_18=normalize(l9_11);
vec3 l9_19=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_20;
#if (sc_SSAOEnabled)
{
l9_20=evaluateSSAO(varPos);
}
#else
{
l9_20=clamp(vec3(l9_10.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_21=vec3(l9_15);
vec3 l9_22=mix(vec3(0.039999999),l9_17*l9_15,l9_21);
vec3 l9_23=mix(l9_17*(1.0-l9_15),vec3(0.0),l9_21);
SurfaceProperties l9_24=SurfaceProperties(l9_23,l9_12,l9_18,varPos,l9_0,l9_15,l9_16,l9_19,l9_20,Port_SpecularAO_N006,vec3(1.0),l9_22);
vec4 l9_25=vec4(1.0);
vec3 l9_26;
vec3 l9_27;
vec3 l9_28;
...
l9_34=vec3(0.0);
l9_33=vec3(0.0);
LightingComponents l9_40;
LightProperties l9_41;
SurfaceProperties l9_42;
vec3 l9_43;
int l9_44=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_44<sc_DirectionalLightsCount)
{
LightingComponents l9_45=accumulateLight(LightingComponents(l9_33,l9_34,l9_39,l9_38,l9_36,l9_35),LightProperties(sc_DirectionalLights[l9_44].direction,sc_DirectionalLights[l9_44].color.xyz,sc_DirectionalLights[l9_44].color.w*l9_25[(l9_37<3) ? l9_37 : 3]),l9_24,l9_0);
l9_39=l9_45.indirectDiffuse;
l9_38=l9_45.indirectSpecular;
l9_37++;
l9_36=l9_45.emitted;
l9_35=l9_45.transmitted;
l9_34=l9_45.directSpecular;
l9_33=l9_45.directDiffuse;
l9_44++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_62<sc_PointLightsCount)
{
vec3 l9_64=sc_PointLights[l9_62].position-varPos;
vec3 l9_65=normalize(l9_64);
float l9_66=l9_25[(l9_63<3) ? l9_63 : 3];
float l9_67=clamp((dot(l9_65,sc_PointLights[l9_62].direction)*sc_PointLights[l9_62].angleScale)+sc_PointLights[l9_62].angleOffset,0.0,1.0);
float l9_68=(sc_PointLights[l9_62].color.w*l9_66)*(l9_67*l9_67);
float l9_69;
if (sc_PointLights[l9_62].falloffEnabled)
{
l9_69=l9_68*computeDistanceAttenuation(length(l9_64),sc_PointLights[l9_62].falloffEndDistance);
}
else
{
l9_69=l9_68;
...
l9_55=l9_63+1;
LightingComponents l9_70=accumulateLight(LightingComponents(l9_49,l9_50,l9_54,l9_53,l9_52,l9_51),LightProperties(l9_65,sc_PointLights[l9_62].color.xyz,l9_69),l9_24,l9_0);
l9_56=l9_70.directDiffuse;
l9_57=l9_70.directSpecular;
l9_58=l9_70.indirectDiffuse;
l9_59=l9_70.indirectSpecular;
l9_60=l9_70.emitted;
l9_61=l9_70.transmitted;
l9_54=l9_58;
l9_53=l9_59;
l9_63=l9_55;
l9_52=l9_60;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_74=abs(varShadowTex-vec2(0.5));
vec4 l9_75=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_74.x,l9_74.y),0.5);
l9_73=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_75.xyz,vec3(sc_ShadowColor.w)),vec3(l9_75.w*sc_ShadowDensity));
}
#else
{
l9_73=vec3(1.0);
...
{
vec2 l9_77=calcPanoramicTexCoordsFromDir(l9_18,sc_EnvmapRotation.y);
vec4 l9_78;
...
#endif
l9_80=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_81,sc_EnvmapDiffuseLayout,l9_82,-13.0,sc_EnvmapDiffuse);
}
#else
{
...
float l9_86=l9_84.y;
float l9_87=l9_84.z;
l9_83=(((((((sc_Sh[8]*0.42904299)*((l9_85*l9_85)-(l9_86*l9_86)))+((sc_Sh[6]*0.74312502)*(l9_87*l9_87)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_85*l9_86))+(sc_Sh[7]*(l9_85*l9_87)))+(sc_Sh[5]*(l9_86*l9_87)))*0.85808599))+((((sc_Sh[3]*l9_85)+(sc_Sh[1]*l9_86))+(sc_Sh[2]*l9_87))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_83=vec3(0.0);
...
{
l9_89=l9_76+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_90=l9_76;
l9_90.x=l9_76.x+(1e-06*sc_AmbientLights[0].color.x);
l9_89=l9_90;
}
#endif
l9_88=l9_89;
...
{
float l9_101=dot(sc_LightEstimationData.sg[l9_100].axis,l9_18);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_112=clamp(pow(l9_16,0.66666669),0.0,1.0)*5.0;
vec2 l9_113=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_18,reflect(-l9_0,l9_18),l9_16),sc_EnvmapRotation.y);
vec4 l9_114;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_115=floor(l9_112);
float l9_116=ceil(l9_112);
l9_114=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_113,sc_EnvmapSpecularSize.xy,l9_115),sc_EnvmapSpecularGetStereoViewIndex(),l9_115),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_113,sc_EnvmapSpecularSize.xy,l9_116),sc_EnvmapSpecularGetStereoViewIndex(),l9_116),vec4(l9_112-l9_115));
}
#else
{
l9_114=sc_EnvmapSpecularSampleViewIndexLevel(l9_113,sc_EnvmapSpecularGetStereoViewIndex(),l9_112);
}
#endif
l9_111=vec3(0.0)+((((l9_114.xyz*(1.0/l9_114.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_24,abs(dot(l9_18,l9_0))));
}
#else
{
l9_111=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_118=clamp(l9_16*l9_16,0.0099999998,1.0);
vec3 l9_119;
l9_119=sc_LightEstimationData.ambientLight*l9_22;
int l9_120=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_120<sc_LightEstimationSGCount)
{
float l9_121=l9_118*l9_118;
vec3 l9_122=reflect(-l9_0,l9_18);
float l9_123=dot(l9_18,l9_0);
float l9_124=(2.0/l9_121)/(4.0*max(l9_123,9.9999997e-05));
float l9_125=length((l9_122*l9_124)+(sc_LightEstimationData.sg[l9_120].axis*sc_LightEstimationData.sg[l9_120].sharpness));
float l9_126=clamp(dot(l9_18,l9_122),0.0,1.0);
float l9_127=clamp(l9_123,0.0,1.0);
float l9_128=1.0-l9_121;
l9_119+=((((((((vec3(1.0/(3.1415927*l9_121))*exp((l9_125-l9_124)-sc_LightEstimationData.sg[l9_120].sharpness))*sc_LightEstimationData.sg[l9_120].color)*6.2831855)*(1.0-exp((-2.0)*l9_125)))/vec3(l9_125))*((1.0/(l9_126+sqrt(l9_121+((l9_128*l9_126)*l9_126))))*(1.0/(l9_127+sqrt(l9_121+((l9_128*l9_127)*l9_127))))))*(l9_22+((vec3(1.0)-l9_22)*pow(1.0-clamp(dot(l9_122,normalize(l9_122+l9_0)),0.0,1.0),5.0))))*l9_126);
l9_120++;
continue;
}
else
...
l9_132=vec3(0.0);
l9_131=vec3(0.0);
l9_130=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_23,vec3(l9_12));
l9_129=1.0;
}
#else
{
...
#endif
vec3 l9_134=l9_131*l9_20;
vec3 l9_135=l9_132+l9_134;
vec3 l9_136=l9_23*l9_135;
vec3 l9_137=l9_117*Port_SpecularAO_N006;
vec3 l9_138=l9_71+l9_137;
vec3 l9_139;
if (l9_133)
{
l9_139=l9_136*srgbToLinear(l9_129);
}
else
{
l9_139=l9_136;
}
vec3 l9_140=l9_139+l9_138;
vec3 l9_141=(l9_140+l9_19)+l9_130;
float l9_142=l9_141.x;
vec4 l9_143=vec4(l9_142,l9_141.yz,l9_129);
vec4 l9_144;
#if (sc_IsEditor)
{
vec4 l9_145=l9_143;
l9_145.x=l9_142+((l9_20.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_144=l9_145;
}
#else
{
...
{
vec3 l9_147=l9_144.xyz*1.8;
vec3 l9_148=(l9_144.xyz*(l9_147+vec3(1.4)))/((l9_144.xyz*(l9_147+vec3(0.5)))+vec3(1.5));
l9_146=vec4(l9_148.x,l9_148.y,l9_148.z,l9_144.w);
}
#else
{
l9_146=l9_144;
...
#endif
vec3 l9_149=vec3(linearToSrgb(l9_146.x),linearToSrgb(l9_146.y),linearToSrgb(l9_146.z));
l9_14=vec4(l9_149.x,l9_149.y,l9_149.z,l9_146.w);
}
#endif
vec4 l9_150=max(l9_14,vec4(0.0));
vec4 l9_151;
#if (sc_ProjectiveShadowsCaster)
{
float l9_152;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_153=clamp(l9_150.w*2.0,0.0,1.0);
}
#else
{
float l9_154;
...
{
l9_154=clamp(dot(l9_150.xyz,vec3(l9_150.w)),0.0,1.0);
}
#else
{
float l9_155;
...
#if (sc_BlendMode_Multiply)
{
l9_156=(1.0-dot(l9_150.xyz,vec3(0.33333001)))*l9_150.w;
}
#else
{
float l9_157;
...
{
l9_157=(1.0-clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0))*l9_150.w;
}
#else
{
float l9_158;
#if (sc_BlendMode_ColoredGlass)
{
l9_158=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0)*l9_150.w;
}
#else
{
float l9_159;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_160=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0)*l9_150.w;
}
#else
{
float l9_161;
...
{
l9_161=dot(l9_150.xyz,vec3(0.33333001))*l9_150.w;
}
#else
{
float l9_162;
...
vec3 l9_167=mix(l9_166,definedBlend(l9_166,l9_150.xyz).xyz,vec3(l9_150.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_170=l9_150.w;
l9_169=vec4(mix(vec3(1.0),l9_150.xyz,vec3(l9_170)),l9_170);
}
#else
{
vec4 l9_171;
...
{
float l9_172=l9_150.w;
float l9_173;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_173=clamp(l9_172,0.0,1.0);
}
#else
{
l9_173=l9_172;
...
#endif
l9_171=vec4(l9_150.xyz*l9_173,l9_173);
}
#else
{
l9_171=l9_150;
...
{
l9_176=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_176=vec4(0.0);
...
vec4 l9_178=outputMotionVectorsIfNeeded(varPos,max(l9_177,vec4(0.0)));
vec4 l9_179=clamp(l9_178,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_180=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_180-0.0039215689)),min(1.0,l9_180+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_181=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_181).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_182=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_181).xy);
float l9_183=packValue(l9_182);
int l9_190=int(l9_179.w*255.0);
float l9_191=packValue(l9_190);
sc_writeFragData0(vec4(packValue(l9_182),packValue(l9_182),packValue(l9_182),packValue(l9_182)));
sc_writeFragData1(vec4(l9_183,packValue(l9_182),packValue(l9_182),packValue(l9_182)));
sc_writeFragData2(vec4(l9_191,packValue(l9_190),packValue(l9_190),packValue(l9_190)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_194=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_199==0)
{
l9_202=texture2D(sc_OITAlpha0,l9_194);
l9_201=texture2D(sc_OITDepthLow0,l9_194);
l9_200=texture2D(sc_OITDepthHigh0,l9_194);
}
else
{
l9_202=vec4(0.0);
...
if (l9_199==1)
{
l9_205=texture2D(sc_OITAlpha1,l9_194);
l9_204=texture2D(sc_OITDepthLow1,l9_194);
l9_203=texture2D(sc_OITDepthHigh1,l9_194);
}
else
{
l9_205=l9_202;
...
if (any(notEqual(l9_203,vec4(0.0)))||any(notEqual(l9_204,vec4(0.0))))
{
int l9_206[8]=l9_195;
unpackValues(l9_203.w,l9_199,l9_206);
unpackValues(l9_203.z,l9_199,l9_206);
unpackValues(l9_203.y,l9_199,l9_206);
unpackValues(l9_203.x,l9_199,l9_206);
unpackValues(l9_204.w,l9_199,l9_206);
unpackValues(l9_204.z,l9_199,l9_206);
unpackValues(l9_204.y,l9_199,l9_206);
unpackValues(l9_204.x,l9_199,l9_206);
int l9_215[8]=l9_196;
unpackValues(l9_205.w,l9_199,l9_215);
unpackValues(l9_205.z,l9_199,l9_215);
unpackValues(l9_205.y,l9_199,l9_215);
unpackValues(l9_205.x,l9_199,l9_215);
}
l9_199++;
continue;
}
...
vec4 l9_220=texture2D(sc_OITFilteredDepthBoundsTexture,l9_194);
vec2 l9_221=l9_220.xy;
int l9_222;
#if (sc_SkinBonesCount>0)
{
l9_222=encodeDepth(((1.0-l9_220.x)*1000.0)+getDepthOrderingEpsilon(),l9_221);
}
#else
{
l9_222=0;
...
#endif
int l9_223=encodeDepth(viewSpaceDepth(),l9_221);
vec4 l9_224;
l9_224=l9_179*l9_179.w;
vec4 l9_225;
int l9_226=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_226<8)
{
int l9_227=l9_195[l9_226];
int l9_228=l9_223-l9_222;
bool l9_229=l9_227<l9_228;
bool l9_230;
if (l9_229)
{
l9_230=l9_195[l9_226]>0;
}
else
{
l9_230=l9_229;
...
if (l9_230)
{
vec3 l9_231=l9_224.xyz*(1.0-(float(l9_196[l9_226])/255.0));
l9_225=vec4(l9_231.x,l9_231.y,l9_231.z,l9_224.w);
}
else
{
l9_225=l9_224;
