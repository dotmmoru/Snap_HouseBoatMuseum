...
{
l9_7=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_5.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_7=vec3(0.0);
...
#endif
float l9_8=clamp(l9_4.w,0.0,1.0);
...
{
l9_19=uint(clamp(l9_6.y,0.0,1.0)*1000.0);
}
...
#if (materialParamsTexLayout==2)
{
l9_17=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_17=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_13,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_18=mat3(l9_3,l9_1,l9_2)*((l9_16.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_18=vec3(0.0);
...
#endif
float l9_19=clamp(l9_15.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_20=max(l9_15.xyz,vec3(0.0));
vec4 l9_21;
#if (sc_ProjectiveShadowsCaster)
{
l9_21=vec4(l9_20,l9_19);
}
#else
{
l9_21=ngsCalculateLighting(l9_20,l9_19,l9_18,l9_4,l9_5,Port_Emissive_N006,clamp(l9_17.x,0.0,1.0),clamp(l9_17.y,0.0,1.0),clamp(vec3(l9_17.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_22=max(l9_21,vec4(0.0));
if (isProxyMode)
{
vec4 l9_23;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_27=clamp(l9_22.w*2.0,0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_22.xyz,vec3(l9_22.w)),0.0,1.0);
}
#else
{
float l9_29;
...
#if (sc_BlendMode_Multiply)
{
l9_30=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*l9_22.w;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*l9_22.w;
}
#else
{
float l9_32;
#if (sc_BlendMode_ColoredGlass)
{
l9_32=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_22.w;
}
#else
{
float l9_33;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_22.w;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_22.xyz,vec3(0.33333001))*l9_22.w;
}
#else
{
float l9_36;
...
vec3 l9_41=mix(l9_40,definedBlend(l9_40,l9_22.xyz).xyz,vec3(l9_22.w));
...
{
float l9_44=l9_22.w;
l9_43=vec4(mix(vec3(1.0),l9_22.xyz,vec3(l9_44)),l9_44);
}
#else
{
vec4 l9_45;
...
#endif
l9_45=vec4(l9_22.xyz*l9_47,l9_47);
}
#else
{
l9_45=l9_22;
