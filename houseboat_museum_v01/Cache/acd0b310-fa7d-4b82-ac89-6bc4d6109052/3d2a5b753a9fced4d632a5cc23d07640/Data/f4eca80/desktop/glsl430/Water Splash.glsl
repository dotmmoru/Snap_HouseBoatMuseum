...
//sampler sampler Tweak_N0SmpSC 2:26
//sampler sampler Tweak_N16SmpSC 2:27
...
//texture texture2D Tweak_N0 2:3:2:26
//texture texture2D Tweak_N16 2:4:2:27
...
//texture texture2DArray Tweak_N0ArrSC 2:42:2:26
//texture texture2DArray Tweak_N16ArrSC 2:43:2:27
...
uniform float Port_Rotation_N089;
uniform vec2 Port_Center_N089;
uniform vec2 Port_Import_N068;
uniform float Port_Import_N069;
uniform float Port_Input1_N070;
uniform vec2 Port_Import_N074;
uniform vec2 Port_Item0_N078;
uniform vec2 Port_Item1_N078;
uniform vec2 Port_Item2_N078;
uniform vec2 Port_Item3_N078;
uniform vec2 Port_Item4_N078;
uniform vec2 Port_Item5_N078;
uniform vec2 Port_Item6_N078;
uniform vec2 Port_Item7_N078;
...
uniform vec4 Port_Input1_N088;
uniform float Port_RangeMinA_N051;
uniform float Port_RangeMaxA_N051;
uniform float Port_RangeMinB_N051;
uniform float Port_RangeMaxB_N051;
uniform vec2 Port_Import_N042;
uniform float Port_RangeMinA_N055;
uniform float Port_RangeMaxA_N055;
uniform float Port_RangeMinB_N055;
uniform float Port_RangeMaxB_N055;
...
uniform float Port_RangeMinA_N005;
uniform float Port_RangeMaxA_N005;
uniform float Port_RangeMinB_N005;
uniform float Port_RangeMaxB_N005;
uniform float Port_Input1_N014;
uniform float Port_Value_N038;
uniform float Port_Input1_N013;
uniform float Port_Input1_N057;
uniform float Port_Input0_N007;
...
uniform float Port_RangeMinA_N043;
uniform float Port_RangeMaxA_N043;
uniform float Port_RangeMinB_N043;
uniform float Port_RangeMaxB_N043;
uniform float Port_Import_N018;
uniform float Port_Input1_N019;
uniform vec2 Port_Import_N023;
uniform vec2 Port_Item0_N026;
uniform vec2 Port_Item1_N026;
uniform vec2 Port_Item2_N026;
uniform vec2 Port_Item3_N026;
uniform vec2 Port_Item4_N026;
uniform vec2 Port_Item5_N026;
uniform vec2 Port_Item6_N026;
uniform vec2 Port_Item7_N026;
uniform float Port_Input2_N031;
uniform float Port_Opacity_N015;
uniform vec3 Port_Normal1_N061;
uniform float Port_Strength1_N061;
...
uniform vec3 Port_Emissive_N015;
uniform float Port_Metallic_N015;
uniform float Port_Roughness_N015;
uniform vec4 Port_Input0_N095;
uniform float Port_Input0_N053;
uniform float Port_Input1_N053;
uniform float Port_RangeMinA_N094;
uniform float Port_RangeMaxA_N094;
uniform float Port_RangeMinB_N094;
uniform float Port_RangeMaxB_N094;
uniform float Port_Input1_N060;
uniform float Port_RangeMinA_N098;
uniform float Port_RangeMaxA_N098;
uniform float Port_RangeMinB_N098;
uniform float Port_RangeMaxB_N098;
uniform vec4 Port_Color_N058;
uniform float Port_Mask_N058;
uniform float Port_Mask_N035;
uniform float Port_Mask_N065;
...
{
l9_30=float(sc_GetLocalInstanceID())/(sc_GeometryInfo.y-1.0);
}
else
{
l9_30=0.0;
...
Interpolator_gInstanceRatio=l9_30;
}
...
void Node89_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
...
void Node78_Float_Array_Value(float Index,out vec2 Value,out float SizeOut,vec2 Item0,vec2 Item1,vec2 Item2,vec2 Item3,vec2 Item4,vec2 Item5,vec2 Item6,vec2 Item7,ssGlobals Globals)
{
vec2 Array[8];
Array[0]=Item0;
Array[1]=Item1;
...
void LoopFunction_N82(float Index,float Ratio,inout vec4 Output,ssGlobals Globals)
{
Globals.Loop_Index_ID0=Index;
Globals.Loop_Ratio_ID0=Ratio;
vec2 param_3;
Node89_Rotate_Coords(Globals.gScreenCoord,Port_Rotation_N089,Port_Center_N089,param_3,Globals);
vec2 l9_0=param_3;
vec2 param_6;
float param_7;
Node78_Float_Array_Value(Globals.Loop_Index_ID0,param_6,param_7,Port_Item0_N078,Port_Item1_N078,Port_Item2_N078,Port_Item3_N078,Port_Item4_N078,Port_Item5_N078,Port_Item6_N078,Port_Item7_N078,Globals);
vec2 l9_1=param_6;
vec2 l9_2=l9_0+((Tweak_N0Size.zw*vec2(exp2(Port_Import_N069)))*l9_1);
float l9_3=Port_Import_N069+Port_Input1_N070;
vec4 l9_4;
#if (Tweak_N0Layout==2)
{
l9_4=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_3,Tweak_N0ArrSC);
}
#else
{
l9_4=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_3,Tweak_N0);
}
#endif
Output+=l9_4;
}
void Node51_Remap(float ValueIn,out float ValueOut,float RangeMinA,float RangeMaxA,float RangeMinB,float RangeMaxB,ssGlobals Globals)
{
...
void Node55_Remap(float ValueIn,out float ValueOut,float RangeMinA,float RangeMaxA,float RangeMinB,float RangeMaxB,ssGlobals Globals)
{
ValueOut=(((ValueIn-RangeMinA)/(RangeMaxA-RangeMinA))*(RangeMaxB-RangeMinB))+RangeMinB;
float l9_0;
if (RangeMaxB>RangeMinB)
...
float param_1;
Node55_Remap(Globals.gInstanceRatio,param_1,Port_RangeMinA_N055,Port_RangeMaxA_N055,Port_RangeMinB_N055,Port_RangeMaxB_N055,Globals);
float l9_1=param_1;
vec2 param_8;
float param_9;
Node84_Float_Array_Value(Globals.Loop_Index_ID0,param_8,param_9,Port_Item0_N084,Port_Item1_N084,Port_Item2_N084,Port_Item3_N084,Port_Item4_N084,Port_Item5_N084,Port_Item6_N084,Port_Item7_N084,Globals);
vec2 l9_2=param_8;
vec2 l9_3=l9_0+((Tweak_N0Size.zw*vec2(exp2(l9_1)))*l9_2);
float l9_4=l9_1+Port_Input1_N045;
vec4 l9_5;
#if (Tweak_N0Layout==2)
{
l9_5=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_4,Tweak_N0ArrSC);
}
#else
{
l9_5=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_4,Tweak_N0);
}
#endif
Output+=l9_5;
}
...
void Node5_Remap(float ValueIn,out float ValueOut,float RangeMinA,float RangeMaxA,float RangeMinB,float RangeMaxB,ssGlobals Globals)
{
ValueOut=(((ValueIn-RangeMinA)/(RangeMaxA-RangeMinA))*(RangeMaxB-RangeMinB))+RangeMinB;
float l9_0;
if (RangeMaxB>RangeMinB)
...
void Node37_Remap(float ValueIn,out float ValueOut,float RangeMinA,float RangeMaxA,float RangeMinB,float RangeMaxB,ssGlobals Globals)
{
ValueOut=(((ValueIn-RangeMinA)/(RangeMaxA-RangeMinA))*(RangeMaxB-RangeMinB))+RangeMinB;
float l9_0;
if (RangeMaxB>RangeMinB)
...
void Node43_Remap(float ValueIn,out float ValueOut,float RangeMinA,float RangeMaxA,float RangeMinB,float RangeMaxB,ssGlobals Globals)
{
ValueOut=(((ValueIn-RangeMinA)/(RangeMaxA-RangeMinA))*(RangeMaxB-RangeMinB))+RangeMinB;
float l9_0;
if (RangeMaxB>RangeMinB)
...
void Node26_Float_Array_Value(float Index,out vec2 Value,out float SizeOut,vec2 Item0,vec2 Item1,vec2 Item2,vec2 Item3,vec2 Item4,vec2 Item5,vec2 Item6,vec2 Item7,ssGlobals Globals)
{
vec2 Array[8];
Array[0]=Item0;
Array[1]=Item1;
...
void LoopFunction_N30(float Index,float Ratio,inout vec4 Output,ssGlobals Globals)
{
Globals.Loop_Index_ID0=Index;
Globals.Loop_Ratio_ID0=Ratio;
vec2 l9_0=Globals.gScreenCoord;
vec3 l9_1=Globals.ViewDirWS;
float param_1;
Node51_Remap(Globals.gInstanceRatio,param_1,Port_RangeMinA_N051,Port_RangeMaxA_N051,Port_RangeMinB_N051,Port_RangeMaxB_N051,Globals);
float l9_2=param_1;
vec2 l9_3=Globals.gScreenCoord;
float param_8;
Node55_Remap(Globals.gInstanceRatio,param_8,Port_RangeMinA_N055,Port_RangeMaxA_N055,Port_RangeMinB_N055,Port_RangeMaxB_N055,Globals);
float l9_4=param_8;
float l9_5=l9_4+Port_Input1_N045;
vec4 l9_6;
#if (Tweak_N0Layout==2)
{
l9_6=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_5,Tweak_N0ArrSC);
}
#else
{
l9_6=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_5,Tweak_N0);
}
#endif
vec4 param_39;
Node104_Loop_8x(vec4(0.0),param_39,Globals);
vec4 l9_7=param_39;
vec4 l9_8=mix(l9_6,l9_7,vec4(Port_Input2_N105));
float l9_9=l9_8.x;
float param_42;
Node5_Remap(l9_2/(l9_9+1.234e-06),param_42,Port_RangeMinA_N005,Port_RangeMaxA_N005,Port_RangeMinB_N005,Port_RangeMaxB_N005,Globals);
float l9_10=param_42;
float l9_11=dFdx(l9_10);
float l9_12=(Port_Value_N038+0.001)-0.001;
float l9_13=dFdy(l9_10);
float param_49;
Node37_Remap(l9_9,param_49,Port_RangeMinA_N037,Port_RangeMaxA_N037,Port_RangeMinB_N037,Port_RangeMaxB_N037,Globals);
float l9_14=param_49;
float l9_15;
if (l9_14<=0.0)
{
l9_15=0.0;
...
{
l9_15=pow(l9_14,Port_Input1_N059);
}
vec3 l9_16=vec3(l9_15);
float param_56;
Node43_Remap(l9_9,param_56,Port_RangeMinA_N043,Port_RangeMaxA_N043,Port_RangeMinB_N043,Port_RangeMaxB_N043,Globals);
float l9_17=param_56;
vec2 param_63;
float param_64;
Node26_Float_Array_Value(Globals.Loop_Index_ID0,param_63,param_64,Port_Item0_N026,Port_Item1_N026,Port_Item2_N026,Port_Item3_N026,Port_Item4_N026,Port_Item5_N026,Port_Item6_N026,Port_Item7_N026,Globals);
vec2 l9_18=param_63;
vec2 l9_19=(l9_0+((refract(-l9_1,vec3((l9_11+Port_Input1_N014)*l9_12,(l9_13+Port_Input1_N013)*(l9_12*Port_Input1_N057),smoothstep(Port_Input0_N007,Port_Input1_N007,l9_10)),Port_Input2_N034)*vec3(Port_Input1_N041))*l9_16).xy)+((Tweak_N16Size.zw*vec2(exp2(l9_17)))*l9_18);
float l9_20=l9_17+Port_Input1_N019;
vec4 l9_21;
#if (Tweak_N16Layout==2)
{
l9_21=sc_SampleTextureLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,l9_20,Tweak_N16ArrSC);
}
#else
{
l9_21=sc_SampleTextureLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,l9_20,Tweak_N16);
}
#endif
Output+=l9_21;
}
...
vec3 l9_9=normalize(sc_Camera.position-varPos);
ssGlobals l9_10=ssGlobals(l9_1,l9_2,0.0,l9_4,0.0,0.0,0.0,vec3(0.0),l9_9,varPos,l9_6,l9_7,l9_8,varPos,Interpolator_gInstanceRatio);
vec2 param_3;
Node89_Rotate_Coords(l9_4,Port_Rotation_N089,Port_Center_N089,param_3,l9_10);
vec2 l9_11=param_3;
float l9_12=Port_Import_N069+Port_Input1_N070;
#if (Tweak_N0Layout==2)
{
}
#else
...
#endif
vec4 l9_13=vec4(0.0);
ssGlobals l9_14=ssGlobals(l9_1,l9_2,0.0,l9_4,0.0,0.0,8.0,vec3(0.0),l9_9,varPos,l9_6,l9_7,l9_8,varPos,Interpolator_gInstanceRatio);
LoopFunction_N82(0.0,0.0,l9_13,l9_14);
LoopFunction_N82(1.0,0.142857,l9_13,l9_14);
LoopFunction_N82(2.0,0.285714,l9_13,l9_14);
LoopFunction_N82(3.0,0.42857099,l9_13,l9_14);
LoopFunction_N82(4.0,0.57142901,l9_13,l9_14);
LoopFunction_N82(5.0,0.71428603,l9_13,l9_14);
LoopFunction_N82(6.0,0.85714298,l9_13,l9_14);
LoopFunction_N82(7.0,1.0,l9_13,l9_14);
float param_30;
Node51_Remap(Interpolator_gInstanceRatio,param_30,Port_RangeMinA_N051,Port_RangeMaxA_N051,Port_RangeMinB_N051,Port_RangeMaxB_N051,l9_10);
float l9_21=param_30;
float param_37;
Node55_Remap(Interpolator_gInstanceRatio,param_37,Port_RangeMinA_N055,Port_RangeMaxA_N055,Port_RangeMinB_N055,Port_RangeMaxB_N055,l9_10);
float l9_22=param_37;
float l9_23=l9_22+Port_Input1_N045;
vec4 l9_24;
#if (Tweak_N0Layout==2)
{
l9_24=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_23,Tweak_N0ArrSC);
}
#else
{
l9_24=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_23,Tweak_N0);
}
#endif
vec4 param_68;
Node104_Loop_8x(vec4(0.0),param_68,l9_10);
vec4 l9_25=param_68;
vec4 l9_26=mix(l9_24,l9_25,vec4(Port_Input2_N105));
float l9_27=l9_26.x;
float param_71;
Node5_Remap(l9_21/(l9_27+1.234e-06),param_71,Port_RangeMinA_N005,Port_RangeMaxA_N005,Port_RangeMinB_N005,Port_RangeMaxB_N005,l9_10);
float l9_28=param_71;
float l9_29=dFdx(l9_28);
float l9_30=(Port_Value_N038+0.001)-0.001;
float l9_31=dFdy(l9_28);
vec3 l9_32=vec3((l9_29+Port_Input1_N014)*l9_30,(l9_31+Port_Input1_N013)*(l9_30*Port_Input1_N057),smoothstep(Port_Input0_N007,Port_Input1_N007,l9_28));
float param_78;
Node37_Remap(l9_27,param_78,Port_RangeMinA_N037,Port_RangeMaxA_N037,Port_RangeMinB_N037,Port_RangeMaxB_N037,l9_10);
float l9_33=param_78;
float l9_34;
if (l9_33<=0.0)
{
l9_34=0.0;
...
{
l9_34=pow(l9_33,Port_Input1_N059);
}
vec3 l9_35=vec3(l9_34);
vec2 l9_36=l9_4+((refract(-l9_9,l9_32,Port_Input2_N034)*vec3(Port_Input1_N041))*l9_35).xy;
float param_85;
Node43_Remap(l9_27,param_85,Port_RangeMinA_N043,Port_RangeMaxA_N043,Port_RangeMinB_N043,Port_RangeMaxB_N043,l9_10);
float l9_37=param_85;
float l9_38=l9_37+Port_Input1_N019;
#if (Tweak_N16Layout==2)
{
}
#else
...
#endif
vec4 l9_39=vec4(0.0);
LoopFunction_N30(0.0,0.0,l9_39,l9_14);
LoopFunction_N30(1.0,0.142857,l9_39,l9_14);
LoopFunction_N30(2.0,0.285714,l9_39,l9_14);
LoopFunction_N30(3.0,0.42857099,l9_39,l9_14);
LoopFunction_N30(4.0,0.57142901,l9_39,l9_14);
LoopFunction_N30(5.0,0.71428603,l9_39,l9_14);
LoopFunction_N30(6.0,0.85714298,l9_39,l9_14);
LoopFunction_N30(7.0,1.0,l9_39,l9_14);
float l9_46=(((l9_26.y-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_47;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_47=clamp(l9_46,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_47=clamp(l9_46,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
float l9_48=(((Interpolator_gInstanceRatio-Port_RangeMinA_N056)/(Port_RangeMaxA_N056-Port_RangeMinA_N056))*(Port_RangeMaxB_N056-Port_RangeMinB_N056))+Port_RangeMinB_N056;
float l9_49;
if (Port_RangeMaxB_N056>Port_RangeMinB_N056)
{
l9_49=clamp(l9_48,Port_RangeMinB_N056,Port_RangeMaxB_N056);
}
else
{
l9_49=clamp(l9_48,Port_RangeMaxB_N056,Port_RangeMinB_N056);
}
float l9_50=l9_47*l9_27;
float l9_51=l9_50*l9_49;
vec3 l9_52=mix(vec3(0.0,0.0,1.0),Port_Normal1_N061,vec3(Port_Strength1_N061))+vec3(0.0,0.0,1.0);
vec3 l9_53=mix(vec3(0.0,0.0,1.0),l9_32,vec3(l9_51))*vec3(-1.0,-1.0,1.0);
vec3 l9_54;
#if (!sc_ProjectiveShadowsCaster)
{
l9_54=mat3(l9_6,l9_8,l9_7)*normalize((l9_52*dot(l9_52,l9_53))-(l9_53*l9_52.z));
}
#else
{
l9_54=vec3(0.0);
...
{
if (Port_Opacity_N015<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Opacity_N015<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
if (dot(l9_9,l9_54)>=(-0.050000001))
{
uvec3 l9_55=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_55.x,l9_55.y,l9_55.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_56=abs(l9_54);
vec3 l9_57=l9_54/vec3(dot(l9_56,vec3(1.0)));
float l9_58=clamp(-l9_57.z,0.0,1.0);
float l9_59=l9_57.x;
float l9_60;
if (l9_59>=0.0)
{
...
uvec2 l9_64=uvec2(packHalf2x16(vec2(l9_61,0.0)),packHalf2x16(vec2(l9_62+l9_63,0.0)));
normal_and_more=uvec4(l9_64.x,l9_64.y,normal_and_more.z,normal_and_more.w);
normal_and_more.z=packHalf2x16(vec2(0.0));
uint l9_65;
if (Port_Roughness_N015<0.0)
{
l9_65=1023u;
}
else
{
l9_65=uint(clamp(Port_Roughness_N015,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_65|uint((receiverId%32)<<int(10u));
}
else
{
...
l9_7=l9_15;
l9_6=l9_12;
l9_5=cross(l9_12,l9_15)*l9_13.w;
l9_4=Interpolator_gInstanceRatio;
l9_3=((l9_14.xy/vec2(l9_14.w))*0.5)+vec2(0.5);
}
else
{
...
l9_7=l9_16;
l9_6=l9_17;
l9_5=cross(l9_17,l9_16)*varTangent.w;
l9_4=Interpolator_gInstanceRatio;
l9_3=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
}
ssGlobals l9_18=ssGlobals(l9_1,l9_2,0.0,l9_3,0.0,0.0,0.0,vec3(0.0),l9_9,l9_8,l9_7,l9_6,l9_5,l9_8,l9_4);
vec2 param_3;
Node89_Rotate_Coords(l9_3,Port_Rotation_N089,Port_Center_N089,param_3,l9_18);
vec2 l9_19=param_3;
float l9_20=Port_Import_N069+Port_Input1_N070;
vec4 l9_21;
#if (Tweak_N0Layout==2)
{
l9_21=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_20,Tweak_N0ArrSC);
}
#else
{
l9_21=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_20,Tweak_N0);
}
#endif
vec4 l9_22=vec4(0.0);
ssGlobals l9_23=ssGlobals(l9_1,l9_2,0.0,l9_3,0.0,0.0,8.0,vec3(0.0),l9_9,l9_8,l9_7,l9_6,l9_5,l9_8,l9_4);
LoopFunction_N82(0.0,0.0,l9_22,l9_23);
LoopFunction_N82(1.0,0.142857,l9_22,l9_23);
LoopFunction_N82(2.0,0.285714,l9_22,l9_23);
LoopFunction_N82(3.0,0.42857099,l9_22,l9_23);
LoopFunction_N82(4.0,0.57142901,l9_22,l9_23);
LoopFunction_N82(5.0,0.71428603,l9_22,l9_23);
LoopFunction_N82(6.0,0.85714298,l9_22,l9_23);
LoopFunction_N82(7.0,1.0,l9_22,l9_23);
vec4 l9_30=l9_22;
vec4 l9_31=mix(l9_21,l9_30/vec4(8.0),vec4(Port_Input2_N083));
float l9_32=(((l9_31.z-Port_RangeMinA_N063)/(Port_RangeMaxA_N063-Port_RangeMinA_N063))*(Port_RangeMaxB_N063-Port_RangeMinB_N063))+Port_RangeMinB_N063;
float l9_33;
if (Port_RangeMaxB_N063>Port_RangeMinB_N063)
{
l9_33=clamp(l9_32,Port_RangeMinB_N063,Port_RangeMaxB_N063);
}
else
{
l9_33=clamp(l9_32,Port_RangeMaxB_N063,Port_RangeMinB_N063);
}
vec4 l9_34=vec4(1.0,1.0,1.0,l9_33);
vec4 l9_35=l9_34*Port_Input1_N088;
vec3 l9_36=-l9_9;
float param_30;
Node51_Remap(l9_4,param_30,Port_RangeMinA_N051,Port_RangeMaxA_N051,Port_RangeMinB_N051,Port_RangeMaxB_N051,l9_18);
float l9_37=param_30;
float param_37;
Node55_Remap(l9_4,param_37,Port_RangeMinA_N055,Port_RangeMaxA_N055,Port_RangeMinB_N055,Port_RangeMaxB_N055,l9_18);
float l9_38=param_37;
float l9_39=l9_38+Port_Input1_N045;
vec4 l9_40;
#if (Tweak_N0Layout==2)
{
l9_40=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_39,Tweak_N0ArrSC);
}
#else
{
l9_40=sc_SampleTextureLevel(Tweak_N0Dims.xy,Tweak_N0Layout,Tweak_N0GetStereoViewIndex(),l9_3,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,l9_39,Tweak_N0);
}
#endif
vec4 param_68;
Node104_Loop_8x(vec4(0.0),param_68,l9_18);
vec4 l9_41=param_68;
vec4 l9_42=mix(l9_40,l9_41,vec4(Port_Input2_N105));
float l9_43=l9_42.x;
float param_71;
Node5_Remap(l9_37/(l9_43+1.234e-06),param_71,Port_RangeMinA_N005,Port_RangeMaxA_N005,Port_RangeMinB_N005,Port_RangeMaxB_N005,l9_18);
float l9_44=param_71;
float l9_45=dFdx(l9_44);
float l9_46=(Port_Value_N038+0.001)-0.001;
float l9_47=dFdy(l9_44);
float l9_48=smoothstep(Port_Input0_N007,Port_Input1_N007,l9_44);
vec3 l9_49=vec3((l9_45+Port_Input1_N014)*l9_46,(l9_47+Port_Input1_N013)*(l9_46*Port_Input1_N057),l9_48);
float param_78;
Node37_Remap(l9_43,param_78,Port_RangeMinA_N037,Port_RangeMaxA_N037,Port_RangeMinB_N037,Port_RangeMaxB_N037,l9_18);
float l9_50=param_78;
float l9_51;
if (l9_50<=0.0)
{
l9_51=0.0;
...
{
l9_51=pow(l9_50,Port_Input1_N059);
}
vec3 l9_52=vec3(l9_51);
vec2 l9_53=l9_3+((refract(l9_36,l9_49,Port_Input2_N034)*vec3(Port_Input1_N041))*l9_52).xy;
float param_85;
Node43_Remap(l9_43,param_85,Port_RangeMinA_N043,Port_RangeMaxA_N043,Port_RangeMinB_N043,Port_RangeMaxB_N043,l9_18);
float l9_54=param_85;
float l9_55=l9_54+Port_Input1_N019;
vec4 l9_56;
#if (Tweak_N16Layout==2)
{
l9_56=sc_SampleTextureLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_53,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,l9_55,Tweak_N16ArrSC);
}
#else
{
l9_56=sc_SampleTextureLevel(Tweak_N16Dims.xy,Tweak_N16Layout,Tweak_N16GetStereoViewIndex(),l9_53,(int(SC_USE_UV_TRANSFORM_Tweak_N16)!=0),Tweak_N16Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N16,SC_SOFTWARE_WRAP_MODE_V_Tweak_N16),(int(SC_USE_UV_MIN_MAX_Tweak_N16)!=0),Tweak_N16UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16)!=0),Tweak_N16BorderColor,l9_55,Tweak_N16);
}
#endif
vec4 l9_57=vec4(0.0);
LoopFunction_N30(0.0,0.0,l9_57,l9_23);
LoopFunction_N30(1.0,0.142857,l9_57,l9_23);
LoopFunction_N30(2.0,0.285714,l9_57,l9_23);
LoopFunction_N30(3.0,0.42857099,l9_57,l9_23);
LoopFunction_N30(4.0,0.57142901,l9_57,l9_23);
LoopFunction_N30(5.0,0.71428603,l9_57,l9_23);
LoopFunction_N30(6.0,0.85714298,l9_57,l9_23);
LoopFunction_N30(7.0,1.0,l9_57,l9_23);
vec4 l9_64=l9_57;
vec4 l9_65=mix(l9_56,l9_64/vec4(8.0),vec4(Port_Input2_N031));
float l9_66=(((l9_42.y-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_67;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_67=clamp(l9_66,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_67=clamp(l9_66,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
float l9_68=l9_4-Port_RangeMinA_N056;
float l9_69=((l9_68/(Port_RangeMaxA_N056-Port_RangeMinA_N056))*(Port_RangeMaxB_N056-Port_RangeMinB_N056))+Port_RangeMinB_N056;
float l9_70;
if (Port_RangeMaxB_N056>Port_RangeMinB_N056)
{
l9_70=clamp(l9_69,Port_RangeMinB_N056,Port_RangeMaxB_N056);
}
else
{
l9_70=clamp(l9_69,Port_RangeMaxB_N056,Port_RangeMinB_N056);
}
float l9_71=l9_67*l9_43;
float l9_72=l9_71*l9_70;
vec3 l9_73=mix(vec3(0.0,0.0,1.0),Port_Normal1_N061,vec3(Port_Strength1_N061))+vec3(0.0,0.0,1.0);
vec3 l9_74=mix(vec3(0.0,0.0,1.0),l9_49,vec3(l9_72))*vec3(-1.0,-1.0,1.0);
float l9_75=(((l9_43-Port_RangeMinA_N094)/(Port_RangeMaxA_N094-Port_RangeMinA_N094))*(Port_RangeMaxB_N094-Port_RangeMinB_N094))+Port_RangeMinB_N094;
float l9_76;
if (Port_RangeMaxB_N094>Port_RangeMinB_N094)
{
l9_76=clamp(l9_75,Port_RangeMinB_N094,Port_RangeMaxB_N094);
}
else
{
l9_76=clamp(l9_75,Port_RangeMaxB_N094,Port_RangeMinB_N094);
}
float l9_77=smoothstep(Port_Input0_N053,Port_Input1_N053,l9_76);
float l9_78;
if (l9_77<=0.0)
{
l9_78=0.0;
...
{
l9_78=pow(l9_77,Port_Input1_N060);
}
vec4 l9_79=vec4(l9_78);
vec3 l9_80;
#if (!sc_ProjectiveShadowsCaster)
{
l9_80=mat3(l9_7,l9_5,l9_6)*normalize((l9_73*dot(l9_73,l9_74))-(l9_74*l9_73.z));
}
#else
{
l9_80=vec3(0.0);
...
#endif
vec3 l9_81=max(l9_65.xyz,vec3(0.0));
vec4 l9_82;
#if (sc_ProjectiveShadowsCaster)
{
l9_82=vec4(l9_81,Port_Opacity_N015);
}
#else
{
l9_82=ngsCalculateLighting(l9_81,Port_Opacity_N015,l9_80,l9_8,l9_9,Port_Emissive_N015,Port_Metallic_N015,Port_Roughness_N015,vec3(1.0),clamp((Port_Input0_N095*l9_79).xyz,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_83=max(l9_82,vec4(0.0));
vec4 l9_84=vec4(Port_RangeMinB_N098);
vec4 l9_85=(((l9_83-vec4(Port_RangeMinA_N098))/vec4(Port_RangeMaxA_N098-Port_RangeMinA_N098))*(Port_RangeMaxB_N098-Port_RangeMinB_N098))+l9_84;
vec4 l9_86;
if (Port_RangeMaxB_N098>Port_RangeMinB_N098)
{
l9_86=clamp(l9_85,l9_84,vec4(Port_RangeMaxB_N098));
}
else
{
l9_86=clamp(l9_85,vec4(Port_RangeMaxB_N098),l9_84);
}
vec3 l9_87=Port_Color_N058.xyz*Port_Color_N058.w;
vec4 l9_88=vec4(l9_87.x,l9_87.y,l9_87.z,Port_Color_N058.w);
vec3 l9_89=l9_86.xyz*l9_86.w;
vec4 l9_90=vec4(l9_89.x,l9_89.y,l9_89.z,l9_86.w);
vec3 l9_91=l9_35.xyz*l9_35.w;
vec4 l9_92=vec4(1.0)-((vec4(1.0)-(min(l9_90+mix((l9_65*2.0)*l9_88,vec4(1.0)-(((vec4(1.0)-l9_65)*2.0)*(vec4(1.0)-l9_88)),step(vec4(0.5),l9_65)),vec4(1.0))*vec4(1.0,1.0,1.0,l9_48)))*(vec4(1.0)-vec4(l9_91.x,l9_91.y,l9_91.z,l9_35.w)));
if (isProxyMode)
{
vec4 l9_93;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_93,vec4(0.0)));
return;
}
vec4 l9_95;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_97=clamp(l9_92.w*2.0,0.0,1.0);
}
#else
{
float l9_98;
...
{
l9_98=clamp(dot(l9_92.xyz,vec3(l9_92.w)),0.0,1.0);
}
#else
{
float l9_99;
...
#if (sc_BlendMode_Multiply)
{
l9_100=(1.0-dot(l9_92.xyz,vec3(0.33333001)))*l9_92.w;
}
#else
{
float l9_101;
...
{
l9_101=(1.0-clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0))*l9_92.w;
}
#else
{
float l9_102;
#if (sc_BlendMode_ColoredGlass)
{
l9_102=clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0)*l9_92.w;
}
#else
{
float l9_103;
#if (sc_BlendMode_Add)
{
l9_103=clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_104;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_104=clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0)*l9_92.w;
}
#else
{
float l9_105;
...
{
l9_105=dot(l9_92.xyz,vec3(0.33333001))*l9_92.w;
}
#else
{
float l9_106;
#if (sc_BlendMode_Min)
{
l9_106=1.0-clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_107;
#if (sc_BlendMode_Max)
{
l9_107=clamp(dot(l9_92.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_107=1.0;
...
#endif
l9_95=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_92.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_96);
}
#else
{
vec4 l9_108;
...
{
vec3 l9_110=sc_GetFramebufferColor().xyz;
vec3 l9_111=mix(l9_110,definedBlend(l9_110,l9_92.xyz).xyz,vec3(l9_92.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_114=l9_92.w;
l9_113=vec4(mix(vec3(1.0),l9_92.xyz,vec3(l9_114)),l9_114);
}
#else
{
vec4 l9_115;
...
{
float l9_116=l9_92.w;
float l9_117;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_117=clamp(l9_116,0.0,1.0);
}
#else
{
l9_117=l9_116;
...
#endif
l9_115=vec4(l9_92.xyz*l9_117,l9_117);
}
#else
{
l9_115=l9_92;
...
#endif
int l9_126=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_125).xy);
...
if (l9_143==0)
{
l9_146=texture(sc_OITAlpha0,l9_138);
l9_145=texture(sc_OITDepthLow0,l9_138);
l9_144=texture(sc_OITDepthHigh0,l9_138);
}
else
{
l9_146=vec4(0.0);
...
if (l9_143==1)
{
l9_149=texture(sc_OITAlpha1,l9_138);
l9_148=texture(sc_OITDepthLow1,l9_138);
l9_147=texture(sc_OITDepthHigh1,l9_138);
}
else
{
l9_149=l9_146;
...
vec4 l9_164=texture(sc_OITFilteredDepthBoundsTexture,l9_138);
