...
//sampler sampler Tweak_N12SmpSC 2:19
//sampler sampler baseTexSmpSC 2:20
//sampler sampler intensityTextureSmpSC 2:21
//sampler sampler materialParamsTexSmpSC 2:22
...
//texture texture2D Tweak_N12 2:0:2:19
//texture texture2D baseTex 2:1:2:20
//texture texture2D intensityTexture 2:2:2:21
//texture texture2D materialParamsTex 2:3:2:22
...
vec2 l9_5=((varPackedTex.xy-Port_Center_N016)*vec2(uvScale))+Port_Center_N016;
int l9_6;
...
#endif
vec4 l9_7=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_6,l9_5,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_8=baseColor*l9_7;
int l9_9;
...
#endif
vec4 l9_10=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,l9_9,l9_5,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
int l9_11;
...
#endif
vec4 l9_12=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,l9_11,l9_5,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
vec3 l9_13;
#if (!sc_ProjectiveShadowsCaster)
{
l9_13=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_10.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_13=vec3(0.0);
...
#endif
float l9_14=clamp(l9_8.w,0.0,1.0);
...
#endif
vec3 l9_15=max(l9_8.xyz,vec3(0.0));
vec4 l9_16;
#if (sc_ProjectiveShadowsCaster)
{
l9_16=vec4(l9_15,l9_14);
}
#else
{
float l9_17=clamp(l9_12.x,0.0,1.0);
float l9_18=clamp(l9_12.y,0.0,1.0);
vec3 l9_19=ssSRGB_to_Linear(l9_15);
vec3 l9_20=normalize(l9_13);
vec3 l9_21=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_22;
#if (sc_SSAOEnabled)
{
l9_22=evaluateSSAO(varPos);
}
#else
{
l9_22=clamp(vec3(l9_12.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_23=vec3(l9_17);
vec3 l9_24=mix(vec3(0.039999999),l9_19*l9_17,l9_23);
vec3 l9_25=mix(l9_19*(1.0-l9_17),vec3(0.0),l9_23);
SurfaceProperties l9_26=SurfaceProperties(l9_25,l9_14,l9_20,varPos,l9_0,l9_17,l9_18,l9_21,l9_22,Port_SpecularAO_N006,vec3(1.0),l9_24);
vec4 l9_27=vec4(1.0);
vec3 l9_28;
vec3 l9_29;
vec3 l9_30;
...
l9_36=vec3(0.0);
l9_35=vec3(0.0);
LightingComponents l9_42;
LightProperties l9_43;
SurfaceProperties l9_44;
vec3 l9_45;
int l9_46=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_46<sc_DirectionalLightsCount)
{
LightingComponents l9_47=accumulateLight(LightingComponents(l9_35,l9_36,l9_41,l9_40,l9_38,l9_37),LightProperties(sc_DirectionalLights[l9_46].direction,sc_DirectionalLights[l9_46].color.xyz,sc_DirectionalLights[l9_46].color.w*l9_27[(l9_39<3) ? l9_39 : 3]),l9_26,l9_0);
l9_41=l9_47.indirectDiffuse;
l9_40=l9_47.indirectSpecular;
l9_39++;
l9_38=l9_47.emitted;
l9_37=l9_47.transmitted;
l9_36=l9_47.directSpecular;
l9_35=l9_47.directDiffuse;
l9_46++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_64<sc_PointLightsCount)
{
vec3 l9_66=sc_PointLights[l9_64].position-varPos;
vec3 l9_67=normalize(l9_66);
float l9_68=l9_27[(l9_65<3) ? l9_65 : 3];
float l9_69=clamp((dot(l9_67,sc_PointLights[l9_64].direction)*sc_PointLights[l9_64].angleScale)+sc_PointLights[l9_64].angleOffset,0.0,1.0);
float l9_70=(sc_PointLights[l9_64].color.w*l9_68)*(l9_69*l9_69);
float l9_71;
if (sc_PointLights[l9_64].falloffEnabled)
{
l9_71=l9_70*computeDistanceAttenuation(length(l9_66),sc_PointLights[l9_64].falloffEndDistance);
}
else
{
l9_71=l9_70;
...
l9_57=l9_65+1;
LightingComponents l9_72=accumulateLight(LightingComponents(l9_51,l9_52,l9_56,l9_55,l9_54,l9_53),LightProperties(l9_67,sc_PointLights[l9_64].color.xyz,l9_71),l9_26,l9_0);
l9_58=l9_72.directDiffuse;
l9_59=l9_72.directSpecular;
l9_60=l9_72.indirectDiffuse;
l9_61=l9_72.indirectSpecular;
l9_62=l9_72.emitted;
l9_63=l9_72.transmitted;
l9_56=l9_60;
l9_55=l9_61;
l9_65=l9_57;
l9_54=l9_62;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_76=abs(varShadowTex-vec2(0.5));
vec4 l9_77=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_76.x,l9_76.y),0.5);
l9_75=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_77.xyz,vec3(sc_ShadowColor.w)),vec3(l9_77.w*sc_ShadowDensity));
}
#else
{
l9_75=vec3(1.0);
...
{
vec2 l9_79=calcPanoramicTexCoordsFromDir(l9_20,sc_EnvmapRotation.y);
vec4 l9_80;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_81=calcSeamlessPanoramicUvsForSampling(l9_79,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_81=l9_79;
...
#endif
l9_80=sc_EnvmapSpecularSampleViewIndexBias(l9_81,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_82;
...
{
vec2 l9_83=calcSeamlessPanoramicUvsForSampling(l9_79,sc_EnvmapDiffuseSize.xy,0.0);
int l9_84;
...
#endif
l9_82=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_83,sc_EnvmapDiffuseLayout,l9_84,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_82=sc_EnvmapSpecularSampleViewIndexBias(l9_79,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_80=l9_82;
}
#endif
l9_78=(l9_80.xyz*(1.0/l9_80.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_85;
...
{
l9_91=l9_78+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_92=l9_78;
l9_92.x=l9_78.x+(1e-06*sc_AmbientLights[0].color.x);
l9_91=l9_92;
}
#endif
l9_90=l9_91;
...
{
float l9_103=dot(sc_LightEstimationData.sg[l9_102].axis,l9_20);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_114=clamp(pow(l9_18,0.66666669),0.0,1.0)*5.0;
vec2 l9_115=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_20,reflect(-l9_0,l9_20),l9_18),sc_EnvmapRotation.y);
vec4 l9_116;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_117=floor(l9_114);
float l9_118=ceil(l9_114);
l9_116=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_115,sc_EnvmapSpecularSize.xy,l9_117),sc_EnvmapSpecularGetStereoViewIndex(),l9_117),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_115,sc_EnvmapSpecularSize.xy,l9_118),sc_EnvmapSpecularGetStereoViewIndex(),l9_118),vec4(l9_114-l9_117));
}
#else
{
l9_116=sc_EnvmapSpecularSampleViewIndexLevel(l9_115,sc_EnvmapSpecularGetStereoViewIndex(),l9_114);
}
#endif
l9_113=vec3(0.0)+((((l9_116.xyz*(1.0/l9_116.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_26,abs(dot(l9_20,l9_0))));
}
#else
{
l9_113=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_120=clamp(l9_18*l9_18,0.0099999998,1.0);
vec3 l9_121;
l9_121=sc_LightEstimationData.ambientLight*l9_24;
int l9_122=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_122<sc_LightEstimationSGCount)
{
float l9_123=l9_120*l9_120;
vec3 l9_124=reflect(-l9_0,l9_20);
float l9_125=dot(l9_20,l9_0);
float l9_126=(2.0/l9_123)/(4.0*max(l9_125,9.9999997e-05));
float l9_127=length((l9_124*l9_126)+(sc_LightEstimationData.sg[l9_122].axis*sc_LightEstimationData.sg[l9_122].sharpness));
float l9_128=clamp(dot(l9_20,l9_124),0.0,1.0);
float l9_129=clamp(l9_125,0.0,1.0);
float l9_130=1.0-l9_123;
l9_121+=((((((((vec3(1.0/(3.1415927*l9_123))*exp((l9_127-l9_126)-sc_LightEstimationData.sg[l9_122].sharpness))*sc_LightEstimationData.sg[l9_122].color)*6.2831855)*(1.0-exp((-2.0)*l9_127)))/vec3(l9_127))*((1.0/(l9_128+sqrt(l9_123+((l9_130*l9_128)*l9_128))))*(1.0/(l9_129+sqrt(l9_123+((l9_130*l9_129)*l9_129))))))*(l9_24+((vec3(1.0)-l9_24)*pow(1.0-clamp(dot(l9_124,normalize(l9_124+l9_0)),0.0,1.0),5.0))))*l9_128);
l9_122++;
continue;
}
else
...
l9_134=vec3(0.0);
l9_133=vec3(0.0);
l9_132=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_25,vec3(l9_14));
l9_131=1.0;
}
#else
{
...
#endif
vec3 l9_136=l9_133*l9_22;
vec3 l9_137=l9_134+l9_136;
vec3 l9_138=l9_25*l9_137;
vec3 l9_139=l9_119*Port_SpecularAO_N006;
vec3 l9_140=l9_73+l9_139;
vec3 l9_141;
if (l9_135)
{
l9_141=l9_138*srgbToLinear(l9_131);
}
else
{
l9_141=l9_138;
}
vec3 l9_142=l9_141+l9_140;
vec3 l9_143=(l9_142+l9_21)+l9_132;
float l9_144=l9_143.x;
vec4 l9_145=vec4(l9_144,l9_143.yz,l9_131);
vec4 l9_146;
#if (sc_IsEditor)
{
vec4 l9_147=l9_145;
l9_147.x=l9_144+((l9_22.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_146=l9_147;
}
#else
{
...
{
vec3 l9_149=l9_146.xyz*1.8;
vec3 l9_150=(l9_146.xyz*(l9_149+vec3(1.4)))/((l9_146.xyz*(l9_149+vec3(0.5)))+vec3(1.5));
l9_148=vec4(l9_150.x,l9_150.y,l9_150.z,l9_146.w);
}
#else
{
l9_148=l9_146;
...
#endif
vec3 l9_151=vec3(linearToSrgb(l9_148.x),linearToSrgb(l9_148.y),linearToSrgb(l9_148.z));
l9_16=vec4(l9_151.x,l9_151.y,l9_151.z,l9_148.w);
}
#endif
vec4 l9_152=max(l9_16,vec4(0.0));
int l9_153;
...
#endif
vec4 l9_154=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,l9_153,l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12);
vec4 l9_155=vec4(Port_RangeMinB_N018);
vec4 l9_156=(((l9_154-vec4(Port_RangeMinA_N018))/vec4(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+l9_155;
vec4 l9_157;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_157=clamp(l9_156,l9_155,vec4(Port_RangeMaxB_N018));
}
else
{
l9_157=clamp(l9_156,vec4(Port_RangeMaxB_N018),l9_155);
}
vec4 l9_158=l9_152*vec4(1.0,1.0,1.0,l9_157.x);
vec4 l9_159;
#if (sc_ProjectiveShadowsCaster)
{
float l9_160;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_161=clamp(l9_158.w*2.0,0.0,1.0);
}
#else
{
float l9_162;
...
{
l9_162=clamp(dot(l9_158.xyz,vec3(l9_158.w)),0.0,1.0);
}
#else
{
float l9_163;
...
#if (sc_BlendMode_Multiply)
{
l9_164=(1.0-dot(l9_158.xyz,vec3(0.33333001)))*l9_158.w;
}
#else
{
float l9_165;
...
{
l9_165=(1.0-clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0))*l9_158.w;
}
#else
{
float l9_166;
#if (sc_BlendMode_ColoredGlass)
{
l9_166=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0)*l9_158.w;
}
#else
{
float l9_167;
...
{
l9_169=dot(l9_158.xyz,vec3(0.33333001))*l9_158.w;
}
#else
{
float l9_170;
...
vec3 l9_175=mix(l9_174,definedBlend(l9_174,l9_158.xyz).xyz,vec3(l9_158.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_178=l9_158.w;
l9_177=vec4(mix(vec3(1.0),l9_158.xyz,vec3(l9_178)),l9_178);
}
#else
{
vec4 l9_179;
...
#endif
l9_179=vec4(l9_158.xyz*l9_181,l9_181);
}
#else
{
l9_179=l9_158;
...
{
l9_184=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_184=vec4(0.0);
...
vec4 l9_186=outputMotionVectorsIfNeeded(varPos,max(l9_185,vec4(0.0)));
vec4 l9_187=clamp(l9_186,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_188=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_188-0.0039215689)),min(1.0,l9_188+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_189=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_189).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_190=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_189).xy);
float l9_191=packValue(l9_190);
int l9_198=int(l9_187.w*255.0);
float l9_199=packValue(l9_198);
sc_writeFragData0(vec4(packValue(l9_190),packValue(l9_190),packValue(l9_190),packValue(l9_190)));
sc_writeFragData1(vec4(l9_191,packValue(l9_190),packValue(l9_190),packValue(l9_190)));
sc_writeFragData2(vec4(l9_199,packValue(l9_198),packValue(l9_198),packValue(l9_198)));
...
if (l9_207==0)
{
l9_210=texture2D(sc_OITAlpha0,l9_202);
l9_209=texture2D(sc_OITDepthLow0,l9_202);
l9_208=texture2D(sc_OITDepthHigh0,l9_202);
}
else
{
l9_210=vec4(0.0);
...
if (l9_207==1)
{
l9_213=texture2D(sc_OITAlpha1,l9_202);
l9_212=texture2D(sc_OITDepthLow1,l9_202);
l9_211=texture2D(sc_OITDepthHigh1,l9_202);
}
else
{
l9_213=l9_210;
...
if (any(notEqual(l9_211,vec4(0.0)))||any(notEqual(l9_212,vec4(0.0))))
{
int l9_214[8]=l9_203;
unpackValues(l9_211.w,l9_207,l9_214);
unpackValues(l9_211.z,l9_207,l9_214);
unpackValues(l9_211.y,l9_207,l9_214);
unpackValues(l9_211.x,l9_207,l9_214);
unpackValues(l9_212.w,l9_207,l9_214);
unpackValues(l9_212.z,l9_207,l9_214);
unpackValues(l9_212.y,l9_207,l9_214);
unpackValues(l9_212.x,l9_207,l9_214);
int l9_223[8]=l9_204;
unpackValues(l9_213.w,l9_207,l9_223);
unpackValues(l9_213.z,l9_207,l9_223);
unpackValues(l9_213.y,l9_207,l9_223);
unpackValues(l9_213.x,l9_207,l9_223);
}
l9_207++;
continue;
}
...
vec4 l9_228=texture2D(sc_OITFilteredDepthBoundsTexture,l9_202);
vec2 l9_229=l9_228.xy;
int l9_230;
#if (sc_SkinBonesCount>0)
{
l9_230=encodeDepth(((1.0-l9_228.x)*1000.0)+getDepthOrderingEpsilon(),l9_229);
}
#else
{
l9_230=0;
...
#endif
int l9_231=encodeDepth(viewSpaceDepth(),l9_229);
vec4 l9_232;
l9_232=l9_187*l9_187.w;
vec4 l9_233;
int l9_234=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_234<8)
{
int l9_235=l9_203[l9_234];
int l9_236=l9_231-l9_230;
bool l9_237=l9_235<l9_236;
bool l9_238;
if (l9_237)
{
l9_238=l9_203[l9_234]>0;
}
else
{
l9_238=l9_237;
...
if (l9_238)
{
vec3 l9_239=l9_232.xyz*(1.0-(float(l9_204[l9_234])/255.0));
l9_233=vec4(l9_239.x,l9_239.y,l9_239.z,l9_232.w);
}
else
{
l9_233=l9_232;
