...
#endif
vec4 l9_27=l9_26-vec4(Port_RangeMinA_N018);
vec4 l9_28=vec4(Port_RangeMinB_N018);
vec4 l9_29=((l9_27/vec4(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+l9_28;
vec4 l9_30;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_30=clamp(l9_29,l9_28,vec4(Port_RangeMaxB_N018));
}
else
{
l9_30=clamp(l9_29,vec4(Port_RangeMaxB_N018),l9_28);
}
vec4 l9_31=l9_25*vec4(1.0,1.0,1.0,l9_30.x);
if (isProxyMode)
{
vec4 l9_32;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_36=clamp(l9_31.w*2.0,0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_31.xyz,vec3(l9_31.w)),0.0,1.0);
}
#else
{
float l9_38;
...
#if (sc_BlendMode_Multiply)
{
l9_39=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*l9_31.w;
}
#else
{
float l9_40;
...
{
l9_40=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*l9_31.w;
}
#else
{
float l9_41;
#if (sc_BlendMode_ColoredGlass)
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_31.w;
}
#else
{
float l9_42;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_43=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_31.w;
}
#else
{
float l9_44;
...
{
l9_44=dot(l9_31.xyz,vec3(0.33333001))*l9_31.w;
}
#else
{
float l9_45;
...
{
vec3 l9_49=sc_GetFramebufferColor().xyz;
vec3 l9_50=mix(l9_49,definedBlend(l9_49,l9_31.xyz).xyz,vec3(l9_31.w));
...
{
float l9_53=l9_31.w;
l9_52=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_53)),l9_53);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_31.xyz*l9_56,l9_56);
}
#else
{
l9_54=l9_31;
