...
//sampler sampler Tweak_N12SmpSC 2:28
//sampler sampler baseTexSmpSC 2:29
//sampler sampler intensityTextureSmpSC 2:30
//sampler sampler materialParamsTexSmpSC 2:31
...
//texture texture2D Tweak_N12 2:3:2:28
//texture texture2D baseTex 2:4:2:29
//texture texture2D intensityTexture 2:5:2:30
//texture texture2D materialParamsTex 2:6:2:31
...
//texture texture2DArray Tweak_N12ArrSC 2:46:2:28
//texture texture2DArray baseTexArrSC 2:47:2:29
//texture texture2DArray intensityTextureArrSC 2:48:2:30
//texture texture2DArray materialParamsTexArrSC 2:49:2:31
//texture texture2DArray normalTexArrSC 2:50:2:32
...
#if (baseTexLayout==2)
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec4 l9_7=baseColor*l9_6;
vec4 l9_8;
#if (normalTexLayout==2)
{
l9_8=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_8=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
{
l9_9=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_5,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
...
{
l9_10=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_8.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_10=vec3(0.0);
...
#endif
float l9_11=clamp(l9_7.w,0.0,1.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_10)>=(-0.050000001))
{
uvec3 l9_12=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_12.x,l9_12.y,l9_12.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_13=abs(l9_10);
vec3 l9_14=l9_10/vec3(dot(l9_13,vec3(1.0)));
float l9_15=clamp(-l9_14.z,0.0,1.0);
float l9_16=l9_14.x;
float l9_17;
if (l9_16>=0.0)
{
...
uvec2 l9_21=uvec2(packHalf2x16(vec2(l9_18,0.0)),packHalf2x16(vec2(l9_19+l9_20,0.0)));
normal_and_more=uvec4(l9_21.x,l9_21.y,normal_and_more.z,normal_and_more.w);
...
{
l9_22=uint(clamp(l9_9.y,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_22|uint((receiverId%32)<<int(10u));
}
else
{
...
float l9_23=floor(float(maskChannel));
if (l9_23==0.0)
{
...
vec3 l9_8=l9_7.positionWS;
vec3 l9_9=l9_7.normalWS;
vec4 l9_10=l9_7.tangentWS;
if (noEarlyZ)
{
...
vec4 l9_12=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_8,1.0);
l9_6=l9_7.viewDirWS;
l9_5=l9_8;
l9_4=l9_11;
l9_3=l9_9;
l9_2=cross(l9_9,l9_11)*l9_10.w;
l9_1=((l9_12.xy/vec2(l9_12.w))*0.5)+vec2(0.5);
l9_0=l9_7.uv0;
}
else
{
...
l9_4=l9_13;
l9_3=l9_14;
l9_2=cross(l9_14,l9_13)*varTangent.w;
l9_1=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
l9_0=varPackedTex.xy;
}
vec2 l9_15=l9_0-Port_Center_N016;
vec2 l9_16=(l9_15*vec2(uvScale))+Port_Center_N016;
vec4 l9_17;
#if (baseTexLayout==2)
{
...
#endif
vec4 l9_18=baseColor*l9_17;
vec4 l9_19;
#if (normalTexLayout==2)
{
l9_19=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTexArrSC);
}
#else
{
l9_19=sc_SampleTextureBiasOrLevel(normalTexDims.xy,normalTexLayout,normalTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex),(int(SC_USE_UV_MIN_MAX_normalTex)!=0),normalTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0),normalTexBorderColor,0.0,normalTex);
...
#if (materialParamsTexLayout==2)
{
l9_20=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTexArrSC);
}
#else
{
l9_20=sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_16,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex);
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_21=mat3(l9_4,l9_2,l9_3)*((l9_19.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_21=vec3(0.0);
...
#endif
float l9_22=clamp(l9_18.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_22<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_22<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_23=max(l9_18.xyz,vec3(0.0));
vec4 l9_24;
#if (sc_ProjectiveShadowsCaster)
{
l9_24=vec4(l9_23,l9_22);
}
#else
{
l9_24=ngsCalculateLighting(l9_23,l9_22,l9_21,l9_5,l9_6,Port_Emissive_N006,clamp(l9_20.x,0.0,1.0),clamp(l9_20.y,0.0,1.0),clamp(vec3(l9_20.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_25=max(l9_24,vec4(0.0));
float l9_26=floor(float(maskChannel));
float l9_27;
if (l9_26==0.0)
{
vec4 l9_28;
...
#if (Tweak_N12Layout==2)
{
l9_30=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12ArrSC);
}
#else
{
l9_30=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12);
...
#if (Tweak_N12Layout==2)
{
l9_32=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12ArrSC);
}
#else
{
l9_32=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12);
...
#if (Tweak_N12Layout==2)
{
l9_33=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12ArrSC);
}
#else
{
l9_33=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12);
...
float l9_34=l9_27-Port_RangeMinA_N018;
float l9_35=((l9_34/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_36;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_36=clamp(l9_35,Port_RangeMinB_N018,Port_RangeMaxB_N018);
}
else
{
l9_36=clamp(l9_35,Port_RangeMaxB_N018,Port_RangeMinB_N018);
}
vec4 l9_37=vec4(1.0,1.0,1.0,l9_36);
vec4 l9_38=l9_25*l9_37;
if (isProxyMode)
{
vec4 l9_39;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_43=clamp(l9_38.w*2.0,0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_44=clamp(dot(l9_38.xyz,vec3(l9_38.w)),0.0,1.0);
}
#else
{
float l9_45;
...
#if (sc_BlendMode_Multiply)
{
l9_46=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*l9_38.w;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*l9_38.w;
}
#else
{
float l9_48;
#if (sc_BlendMode_ColoredGlass)
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_38.w;
}
#else
{
float l9_49;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_38.w;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_38.xyz,vec3(0.33333001))*l9_38.w;
}
#else
{
float l9_52;
...
{
vec3 l9_56=sc_GetFramebufferColor().xyz;
vec3 l9_57=mix(l9_56,definedBlend(l9_56,l9_38.xyz).xyz,vec3(l9_38.w));
...
{
float l9_60=l9_38.w;
l9_59=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_60)),l9_60);
}
#else
{
vec4 l9_61;
...
#endif
l9_61=vec4(l9_38.xyz*l9_63,l9_63);
}
#else
{
l9_61=l9_38;
