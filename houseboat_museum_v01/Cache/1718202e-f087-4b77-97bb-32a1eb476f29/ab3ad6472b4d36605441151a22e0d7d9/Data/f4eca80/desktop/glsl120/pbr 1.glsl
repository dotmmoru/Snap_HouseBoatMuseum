...
float l9_153=floor(float(maskChannel));
float l9_154;
if (l9_153==0.0)
{
l9_154=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12).x;
}
else
{
float l9_155;
if (l9_153==1.0)
{
l9_155=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12).y;
}
else
{
float l9_156;
if (l9_153==2.0)
{
l9_156=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12).z;
}
else
{
l9_156=sc_SampleTextureBiasOrLevel(Tweak_N12Dims.xy,Tweak_N12Layout,Tweak_N12GetStereoViewIndex(),l9_4,(int(SC_USE_UV_TRANSFORM_Tweak_N12)!=0),Tweak_N12Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12),(int(SC_USE_UV_MIN_MAX_Tweak_N12)!=0),Tweak_N12UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12)!=0),Tweak_N12BorderColor,0.0,Tweak_N12).x;
...
float l9_157=l9_154-Port_RangeMinA_N018;
float l9_158=((l9_157/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_159;
if (Port_RangeMaxB_N018>Port_RangeMinB_N018)
{
l9_159=clamp(l9_158,Port_RangeMinB_N018,Port_RangeMaxB_N018);
}
else
{
l9_159=clamp(l9_158,Port_RangeMaxB_N018,Port_RangeMinB_N018);
}
vec4 l9_160=vec4(1.0,1.0,1.0,l9_159);
vec4 l9_161=l9_152*l9_160;
vec4 l9_162;
#if (sc_ProjectiveShadowsCaster)
{
float l9_163;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_164=clamp(l9_161.w*2.0,0.0,1.0);
}
#else
{
float l9_165;
...
{
l9_165=clamp(dot(l9_161.xyz,vec3(l9_161.w)),0.0,1.0);
}
#else
{
float l9_166;
...
#if (sc_BlendMode_Multiply)
{
l9_167=(1.0-dot(l9_161.xyz,vec3(0.33333001)))*l9_161.w;
}
#else
{
float l9_168;
...
{
l9_168=(1.0-clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0))*l9_161.w;
}
#else
{
float l9_169;
#if (sc_BlendMode_ColoredGlass)
{
l9_169=clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0)*l9_161.w;
}
#else
{
float l9_170;
#if (sc_BlendMode_Add)
{
l9_170=clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_171;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_171=clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0)*l9_161.w;
}
#else
{
float l9_172;
...
{
l9_172=dot(l9_161.xyz,vec3(0.33333001))*l9_161.w;
}
#else
{
float l9_173;
#if (sc_BlendMode_Min)
{
l9_173=1.0-clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_174;
#if (sc_BlendMode_Max)
{
l9_174=clamp(dot(l9_161.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_174=1.0;
...
#endif
l9_162=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_161.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_163);
}
#else
{
vec4 l9_175;
...
vec3 l9_178=mix(l9_177,definedBlend(l9_177,l9_161.xyz).xyz,vec3(l9_161.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_181=l9_161.w;
l9_180=vec4(mix(vec3(1.0),l9_161.xyz,vec3(l9_181)),l9_181);
}
#else
{
vec4 l9_182;
...
#endif
l9_182=vec4(l9_161.xyz*l9_184,l9_184);
}
#else
{
l9_182=l9_161;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_192=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_193=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_192).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_205=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_205).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_210==0)
{
l9_213=texture2D(sc_OITAlpha0,l9_205);
l9_212=texture2D(sc_OITDepthLow0,l9_205);
l9_211=texture2D(sc_OITDepthHigh0,l9_205);
}
else
{
l9_213=vec4(0.0);
...
if (l9_210==1)
{
l9_216=texture2D(sc_OITAlpha1,l9_205);
l9_215=texture2D(sc_OITDepthLow1,l9_205);
l9_214=texture2D(sc_OITDepthHigh1,l9_205);
}
else
{
l9_216=l9_213;
...
vec4 l9_231=texture2D(sc_OITFilteredDepthBoundsTexture,l9_205);
