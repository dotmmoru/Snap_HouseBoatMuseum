...
#endif
l9_6=mix(Port_Input0_N006,l9_8,vec3(sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_18,l9_9,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex).x));
}
#else
{
vec3 l9_19;
Node0_Shadow_Sample(l9_19,l9_5);
l9_6=l9_19;
}
#endif
vec4 l9_20=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_20.w=Port_Value2_N001;
...
{
l9_23=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_20.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_20.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_29;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_20.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_32;
...
#endif
vec3 l9_44=mix(l9_42.xyz,definedBlend(l9_42.xyz,l9_20.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_46=vec4(mix(vec3(1.0),l9_20.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_47;
...
{
l9_48=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_48=Port_Value2_N001;
}
#endif
